...
# go up 2 dirs: scripts/maintenance/ ΓåÆ repo root
...
# ΓöÇΓöÇΓöÇ init/README.md ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
w("init/README.md", """\
# SigmaOS Init System (`sigma-init`)

This module implements **PID 1** ΓÇö the first process spawned by the kernel after
...
# ΓöÇΓöÇΓöÇ modules/core/drivers/README.md ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
# ΓöÇΓöÇΓöÇ modules/core/fs/README.md ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
# ΓöÇΓöÇΓöÇ modules/core/kernel/README.md ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
w("modules/core/kernel/README.md", """\
# ╬ú core/kernel ΓÇö Sovereign Microkernel Core

Minimal kernel handling **scheduling, memory management, IPC, syscalls, and
watchdog supervision** ΓÇö structured as composable sovereign shards rather than a
monolithic blob.
...
```
              ...
              ΓööΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓö¼ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÿ
...
- [`scheduling/`](scheduling/) ΓÇö Round-Robin, EDF, real-time lanes
...
- [`modules/core/drivers`](../drivers/README.md) ΓÇö Hardware drivers
- [`modules/core/net`](../net/README.md) ΓÇö Network stack
- [`modules/tools/diag`](../../tools/diag/README.md) ΓÇö Kernel diagnostics
""")

# ΓöÇΓöÇΓöÇ modules/core/net/README.md ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
w("modules/core/net/README.md", """\
# ╬ú core/net ΓÇö Sovereign Networking Stack
...
Application Layer
   ΓööΓöÇ socket.rs          (POSIX-style socket API)
         ΓööΓöÇ tcpip.rs     (TCP/IP stack)
               Γö£ΓöÇ tcp.rs  (TCP state machine)
               Γö£ΓöÇ icmp.rs (ICMP echo / error)
               ΓööΓöÇ sovereign_net.rs  (SovereignNet overlay)
                     Γö£ΓöÇ pqfs.rs       (post-quantum forward secrecy)
                     Γö£ΓöÇ mesh_net.rs   (local mesh)
                     ΓööΓöÇ galactic_*.rs (long-range mesh routing)
```
...
| `sovereign_net.rs` | Encrypted overlay ΓÇö wraps TCP frames with ChaCha20-Poly1305 |
...
// Send data ΓÇö zero-copy if page-aligned
...
- [`modules/core/kernel`](../kernel/README.md) ΓÇö IPC used by net stack
- [`modules/security/isolation`](../../security/isolation/README.md) ΓÇö Network namespace isolation
""")

# ΓöÇΓöÇΓöÇ modules/ext/hal/README.md ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
w("modules/ext/hal/README.md", """\
# ╬ú ext/hal ΓÇö Hardware Abstraction Layer (SovereignHAL)
...
HAL backend ΓÇö nothing else needs to change.
...
- [`modules/core/drivers`](../../core/drivers/README.md) ΓÇö Drivers that use HAL
- [`modules/core/kernel`](../../core/kernel/README.md) ΓÇö Kernel that drives HAL
""")

# ΓöÇΓöÇΓöÇ modules/ext/plugins/README.md ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
w("modules/ext/plugins/README.md", """\
# ╬ú ext/plugins ΓÇö Sovereign Plugin & Extension Framework
...
ΓööΓöÇΓöÇ policy.sigma    # optional MAC policy additions
```
...
- [`modules/tools/sandbox`](../../tools/sandbox/README.md) ΓÇö Capsule isolation
- [`modules/security/access_control`](../../security/access_control/README.md) ΓÇö Capability enforcement
""")

# ΓöÇΓöÇΓöÇ modules/ext/runtimes/README.md ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
# ΓöÇΓöÇΓöÇ modules/perf/bench/README.md ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
w("modules/perf/bench/README.md", """\
# ╬ú perf/bench ΓÇö Sovereign Benchmarking Suite
...
| `mm/page_fault` | Minor page fault handling | ┬╡s |
...
All benchmarks run nightly on bare-metal CI (not in QEMU ΓÇö timing is not
...
- [`modules/perf/scheduler`](../scheduler/README.md) ΓÇö Scheduler performance
- [`modules/perf/mm`](../mm/README.md) ΓÇö Memory manager benchmarks
""")

# ΓöÇΓöÇΓöÇ modules/perf/mm/README.md ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
w("modules/perf/mm/README.md", """\
# ╬ú perf/mm ΓÇö Memory Manager Performance Optimisations
...
```
sigma_malloc(size)
   ΓööΓöÇ Slab Cache (< 512 bytes, O(1) fixed-size slabs)
         ΓööΓöÇ Buddy Allocator (ΓëÑ 512 bytes, power-of-two zones)
               ΓööΓöÇ NUMA Page Allocator (selects nearest memory node)
                     ΓööΓöÇ Physical Frame Allocator (bitmap)
```
...
| **No libc** | `#![no_std]` ΓÇö zero dependency on glibc/musl |
...
```
Node 0 (CPU 0-7,  RAM 0ΓÇô64 GB)
Node 1 (CPU 8-15, RAM 64ΓÇô128 GB)
```
...
- [`modules/core/kernel/memory`](../../core/kernel/memory/) ΓÇö Page-table management
- [`modules/perf/bench`](../bench/README.md) ΓÇö Memory allocator benchmarks
""")

# ΓöÇΓöÇΓöÇ modules/perf/scheduler/README.md ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
w("modules/perf/scheduler/README.md", """\
# ╬ú perf/scheduler ΓÇö Hybrid Sovereign Scheduler
...
SovereignScheduler (abstract)
  ...
  Γö£ΓöÇ RTLane         ΓÇö hard real-time, preempts all other lanes
  Γö£ΓöÇ NUMAFair       ΓÇö CFS analogue, NUMA-topology aware
  ΓööΓöÇ EcoLane        ΓÇö battery/power-optimised (ARM big.LITTLE)
```
...
- [ ] RTLane preemption guarantees (< 5 ┬╡s verified)
...
- [`modules/core/kernel`](../../core/kernel/README.md) ΓÇö Kernel scheduler host
- [`modules/perf/bench`](../bench/README.md) ΓÇö Context-switch benchmark
""")

# ΓöÇΓöÇΓöÇ modules/security/access_control/README.md ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
w("modules/security/access_control/README.md", """\
# ╬ú security/access_control ΓÇö Mandatory Access Control & Audit
...
This makes the audit log **tamper-evident** ΓÇö any modification breaks the hash
...
- [ ] Policy compiler (text ΓåÆ binary rule table)
...
- [`modules/security/isolation`](../isolation/README.md) ΓÇö Process isolation
- [`modules/core/kernel`](../../core/kernel/README.md) ΓÇö Syscall enforcement hooks
""")

# ΓöÇΓöÇΓöÇ modules/security/isolation/README.md ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
w("modules/security/isolation/README.md", """\
# ╬ú security/isolation ΓÇö Sovereign Process Isolation (S-Sandbox)
...
set ΓÇö not even with a kernel exploit.
...
Untrusted App (WASM / ELF)
   ΓööΓöÇ sigma_sandbox_create()         ΓåÉ assigns capability token
         ΓööΓöÇ Shard Boundary (hardware ring separation)
               Γö£ΓöÇ FS namespace  (only allowed paths visible)
               Γö£ΓöÇ Net namespace (only declared ports reachable)
               Γö£ΓöÇ IPC namespace (only approved shard IDs)
               ΓööΓöÇ Memory domain (IOMMU-enforced, no cross-shard DMA)
```
...
- [`modules/security/access_control`](../access_control/README.md) ΓÇö MAC policies
- [`modules/ext/plugins`](../../ext/plugins/README.md) ΓÇö Plugin capsule sandboxing
""")

# ΓöÇΓöÇΓöÇ modules/security/secure_boot/README.md ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
w("modules/security/secure_boot/README.md", """\
# ╬ú security/secure_boot ΓÇö Cryptographic Secure Boot
...
UEFI Firmware (OEM key)
   ΓööΓöÇ SigmaOS UEFI shim (signed with Sovereign Root CA)
         ΓööΓöÇ sigma-boot (Rust UEFI bootloader)
               ΓööΓöÇ Kernel image verification (Ed25519 + SHA-512)
                     ΓööΓöÇ initramfs verification (BLAKE3)
                           ΓööΓöÇ kernel_main()
```
...
| Signing Key | Per-component CI signing | GitHub OIDC ΓåÆ HSM |

## Roadmap

- [ ] Ed25519 signature verification (UEFI phase)
- [ ] BLAKE3 hash chain (initramfs ΓåÆ kernel ΓåÆ rootfs)
...
- [`modules/security/access_control`](../access_control/README.md) ΓÇö Runtime MAC
- [`modules/security/isolation`](../isolation/README.md) ΓÇö Process sandbox
""")

# ΓöÇΓöÇΓöÇ modules/tools/diag/README.md ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
w("modules/tools/diag/README.md", """\
# ╬ú tools/diag ΓÇö Sovereign Diagnostics Toolkit
...
sigma_log!(INFO, "kernel", "shard {id} started in {elapsed_us}┬╡s");
...
```
2026-07-05T14:30:00.000Z INFO  kernel  shard 42 started in 1200┬╡s
```
...
// sigma_vfs_open("/etc/config", O_RDONLY) ΓåÆ 3 [1.2┬╡s]
// sigma_net_send(3, buf, 1024, 0) ΓåÆ 1024 [8.4┬╡s]
...
- [`modules/core/kernel`](../../core/kernel/README.md) ΓÇö Kernel log sources
- [`modules/security/access_control`](../../security/access_control/README.md) ΓÇö Audit chain
""")

# ΓöÇΓöÇΓöÇ modules/tools/loader/README.md ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
w("modules/tools/loader/README.md", """\
# ╬ú tools/loader ΓÇö Sovereign Module Loader
...
Request: load("sigma-net.shard")
   Γöé
   Γö£ΓöÇ 1. Fetch from Sovereign Package Registry (or local path)
   Γöé
   Γö£ΓöÇ 2. Verify Ed25519 signature against Trust Root
   Γöé
   Γö£ΓöÇ 3. Parse ELF / WASM headers
   Γöé
   Γö£ΓöÇ 4. Resolve capability requirements
   Γöé       ΓööΓöÇ Query kernel: does caller hold CAP_MODULE_LOAD?
   Γöé
   Γö£ΓöÇ 5. Map code into isolated memory domain (IOMMU-backed)
   Γöé
   Γö£ΓöÇ 6. Patch relocations + link against sovereign libc
   Γöé
   ΓööΓöÇ 7. Call module entry point with capability token
```
...
- [`modules/ext/plugins`](../../ext/plugins/README.md) ΓÇö Plugin capsule format
- [`modules/security/isolation`](../../security/isolation/README.md) ΓÇö Module sandboxing
""")

# ΓöÇΓöÇΓöÇ modules/tools/sandbox/README.md ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
w("modules/tools/sandbox/README.md", """\
# ╬ú tools/sandbox ΓÇö Sovereign Testing Sandbox
...
| **Kernel regression tests** | Snapshot state ΓåÆ run test ΓåÆ verify ΓåÆ rollback |
...
Test Runner
   ΓööΓöÇ sandbox_create(config)
         ΓööΓöÇ Isolated shard (separate memory domain, IOMMU)
               Γö£ΓöÇ Fake hardware (QEMU device model via virtio)
               Γö£ΓöÇ Snapshot of kernel state (SovereignFS CoW)
               ΓööΓöÇ Instrumented syscall interceptor (for coverage)
```
...
- [`modules/security/isolation`](../../security/isolation/README.md) ΓÇö Production isolation
- [`modules/tools/diag`](../diag/README.md) ΓÇö Syscall tracing
- [`modules/perf/bench`](../../perf/bench/README.md) ΓÇö Performance regression testing
""")

# ΓöÇΓöÇΓöÇ pkg/spm/README.md ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
w("pkg/spm/README.md", """\
# Sovereign Package Manager (SPM / `sigpkg`)

SPM is the cryptographically secure, deterministic package manager for SigmaOS.
Unlike `apt` or `dnf` ΓÇö which rely on global shared state and binary blobs ΓÇö
...
| File | Description |
|---|---|
| `cli.py` | User-facing CLI ΓÇö `sigpkg install`, `remove`, `search`, `rollback` |
| `verifier.py` | Cryptographic core ΓÇö verifies Ed25519 signatures, hash chains |
...
- [`modules/tools/loader`](../../modules/tools/loader/README.md) ΓÇö Module loader
- [`modules/security/secure_boot`](../../modules/security/secure_boot/README.md) ΓÇö Signature verification
""")

# ΓöÇΓöÇΓöÇ wiki_repo/DRIVER_ECOSYSTEM.md (fix inline code fence) ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
# ΓöÇΓöÇΓöÇ wiki_repo/Networking-Shard.md (close unclosed mermaid block) ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
