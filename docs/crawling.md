...
<<<<<<< HEAD:docs/crawling.md
  Follow the directives defined in the target siteâ€™s `robots.txt` file, including disallowed paths and optional crawl-delay settings (see [W3C guidelines](https://www.w3.org/wiki/Write_Web_Crawler)).
=======
