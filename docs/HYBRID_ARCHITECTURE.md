...
| Layer | Design Paradigm | Runtime Paradigm | Overhead |
|-------|-----------------|------------------|----------|
| Kernel Core | OOP Traits | Procedural Loops | ~0ns |
| Device Drivers | OOP Classes | Function Pointer Tables | ~1-2ns |
| Syscall Handlers | OOP Enums | Array-indexed Dispatch | ~5ns |
| Memory Allocator | OOP Structs | Procedural Buddy/Slab | ~10ns |
| Scheduler | OOP State Machine | Procedural Context Switch | ~20ns |

---

*Generated by SigmaOS Development Team — Document Version 1.0.0*
