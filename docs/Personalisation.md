# Personalisation: Dynamic UI Configuration

Replicate user habits, settings, and regional preferences across nodes automatically.

---

## 🎨 Layout and Color Themes

The desktop configuration is driven by declarative TOML config files loaded on session start. The AI agent:
