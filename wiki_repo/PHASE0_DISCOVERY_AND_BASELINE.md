...
| **Scheduler** | SCHED_RR, SCHED_FIFO, BSD ULE, CachyOS BORE, EEVDF, Real-Time EDF | Linux / FreeBSD / CachyOS | `CachyBoreScheduler`, `SovereignMultiQueueRoundRobin`, `SovereignHybridSchedulerInnovations` | ✅ Fully Implemented |
...
1. **x86_64** (AMD64 / Intel 64) — Primary target with full SMEP, SMAP, KASLR, Retpoline, and KPTI hardware mitigations enabled.
