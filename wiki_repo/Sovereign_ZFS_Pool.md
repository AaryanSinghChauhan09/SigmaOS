...
* **Active Devices**: Dynamic allocation up to 8 hardware block devices.
* **RAID-Z Parity**: Distributed block striping and mirrored transaction logs.
...
* **Core Engine**: `kernel/core/SovereignZFSPool.cpp`
* **CLI Controller**: `tools/sigma_zfs.cpp`
