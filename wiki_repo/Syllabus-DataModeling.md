...
## Unit I: Introduction to Data Modeling

### What is Data Modeling?

Data modeling defines the structure, relationships, and constraints of data — the blueprint before implementation.

**SigmaOS Parallel:** Every SigmaDB schema is defined via `SigmaModeler`, which generates validated SQL DDL and ER diagrams.
...
## Unit II: Advanced Data Modeling Techniques
...
3. **Context** — always label axes, title, and units
4. **Appropriate encoding** — bars for comparison, lines for trends, scatter for correlation
...
# KPI summary cards
dash.kpi_card("Total Processes", value=len(procs), delta="+3 since yesterday")
...
# - Don't use misleading scales (truncated Y-axis)
