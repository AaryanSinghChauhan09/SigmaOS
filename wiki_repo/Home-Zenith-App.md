...
2. **Ignition**: Boot and select "Full Productivity Seeding".

3. **Workspace Configuration**: Choose between Tiling (S-TILER) or Floating (Z-UI) window managers.

4. **App Sync**: Run `sigma-pkg sync` to fetch the latest professional shards.
