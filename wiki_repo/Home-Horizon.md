...
2. **Ignition**: Boot and select "Horizon Experimental Ignite".

3. **Connectivity**: Join the Global Lattice Mesh for real-time updates.

4. **Feedback**: Use `s-report` to send telemetry to the development lattice.
