...
Welcome to the official documentation for AI Inference Engine.

## Engine

SigmaOS native AI inference engine.
...
Supported model formats (GGUF, ONNX).
...
Integration with the OS scheduler.
