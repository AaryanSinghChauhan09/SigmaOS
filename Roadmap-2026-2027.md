...
|:---|:---|:---|:---|
| **Cold Boot Time (QEMU x86_64)** | ~1,200 ms | **< 300 ms** | **< 150 ms** |
...
- [Home](Home.md) — Main Wiki documentation hub.
- [Architecture Overview](Architecture-Overview.md) — Modular system architecture.
- [Scheduler Architecture](Scheduler-Architecture.md) — BORE and EEVDF implementation details.
- [Security & Hardening](Security-Hardening.md) — Pledge, unveil, and capabilities.
- [Contributing](Contributing.md) — Engineering standards and pull request workflows.
