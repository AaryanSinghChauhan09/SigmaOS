...
Detailed security management protocols are documented in [`docs/AGENTS_SECURITY_MANAGEMENT.md`](docs/AGENTS_SECURITY_MANAGEMENT.md). All AI agents working on SigmaOS MUST strictly adhere to the following principles:
...
4. **Post-Quantum Cryptography (PQC) & Hardware Enclaves**:
   - Critical key exchange and signature verification MUST support Dilithium-5 and Kyber PQC primitives alongside TPM 2.0 PCR attestation gates (`src/security/pqc_enclave.rs`).
...
## 4. Security Management Protocol Reference

For comprehensive security guidelines, security scanning workflows, and Sentinel 🛡️ auditing procedures, refer to:
- [`docs/AGENTS_SECURITY_MANAGEMENT.md`](docs/AGENTS_SECURITY_MANAGEMENT.md)
- [`.jules/sentinel.md`](.jules/sentinel.md)
