...
| :--- | :--- | :--- | :--- |
| **Linux Kernel** | eBPF, `io_uring`, cgroups v2, SCHED_RR/SCHED_FIFO | C memory safety bugs, complex module dependencies | Native `#![no_std]` Rust async kernel execution, zero-copy socket ring buffers, safety-checked eBPF interpreter. |
