...
public:
    void ExecuteSimulation() override {
        ...
        sigma_sigma_printf("[MATH/NCERT]: Concept: Trigonometry (Class 10-11).\n");
        sigma_sigma_printf("[MATH/NCERT]: sin(30) = " << std::sin(angle) << " (Apex Parity).\n");
    }
...
public:
    void ExecuteSimulation() override {
        sigma_sigma_printf("[MATH/NCERT]: Concept: Probability (Class 12).\n");
        sigma_sigma_printf("[MATH/NCERT]: P(A|B) Bayes' Theorem Shard Active.\n");
    }
...
public:
    void ExecuteSimulation() override {
        ...
        sigma_sigma_printf("[SCIENCE/NCERT]: Concept: Sound & Waves (Class 9).\n");
        sigma_sigma_printf("[SCIENCE/NCERT]: Longitudinal Wave Pulse: " << freq << " Hz.\n");
    }
...
public:
    void ExecuteSimulation() override {
        sigma_sigma_printf("[SCIENCE/NCERT]: Concept: Thermodynamics (Class 11).\n");
        sigma_sigma_printf("[SCIENCE/NCERT]: First Law: dU = dQ - dW (Verified).\n");
    }
...
public:
    void ExecuteSimulation() override {
        sigma_sigma_printf("[SCIENCE/NCERT]: Concept: Semiconductor Electronics (Class 12).\n");
        sigma_sigma_printf("[SCIENCE/NCERT]: p-n Junction Diode Forward Bias Shard Active.\n");
    }
    const char* GetLevel() override { return "Class_12"; }
};
...
public:
    ...
    void ExecuteFullAudit() {
        sigma_sigma_printf("--- Σ SIGMA OS SOVEREIGN NCERT UNITY (SCIENCE & MATH ZENITH) ---\n");
