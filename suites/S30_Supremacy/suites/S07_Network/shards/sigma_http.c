...
const char* sigma_http_get_content_type(const char* filepath) {
    ...
    if (sigma_strcmp(ext, ".html") == 0) return "text/html";
    if (sigma_strcmp(ext, ".css") == 0) return "text/css";
    if (sigma_strcmp(ext, ".js") == 0) return "application/javascript";
    if (sigma_strcmp(ext, ".json") == 0) return "application/json";
    if (sigma_strcmp(ext, ".webp") == 0) return "image/webp";
