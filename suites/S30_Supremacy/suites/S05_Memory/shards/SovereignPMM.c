...
void pmm_init(uint64_t mem_size) {
    ...
    sigma_sigma_memset(g_memory_bitmap, 0xFF, sizeof(g_memory_bitmap)); // Mark all as reserved initially
    ...
    sigma_sigma_printf("S [S05]: Bitmap PMM Materialized. Coverage: %u Pages (%llu MB).\n", 
