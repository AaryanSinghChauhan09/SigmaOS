...
void sigma_interrupt_dispatch(void* context) {
    sigma_sigma_sigma_sigma_printf("S [INTERRUPT]: Hardware pulse detected. Context seated.\n");
    ...
    sigma_sigma_sigma_sigma_printf("  S [AUDIT]: CPU context verified. Resuming Sovereignty.\n");
}
