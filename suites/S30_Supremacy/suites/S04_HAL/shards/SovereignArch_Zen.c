...
sigma_err_t sigma_arch_zen_apply(void) {
    sigma_sigma_sigma_sigma_printf("S [ABSORPTION]: Applying Arch Linux 'Zen' Primitives...\n");
    sigma_sigma_sigma_sigma_printf("  S [ZEN]: Setting preemption threshold to REALTIME.\n");
    sigma_sigma_sigma_sigma_printf("  S [ZEN]: Optimizing CFS latency for interactive workability.\n");
