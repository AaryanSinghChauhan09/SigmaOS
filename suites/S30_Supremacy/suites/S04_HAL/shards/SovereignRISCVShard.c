...
void sigma_riscv_init(void) {
    ...
    sigma_sigma_printf("  S [RISC-V]: OpenSBI interface detected. Machine/Supervisor mode Handshake [OK].\n");
    sigma_sigma_printf("  S [RISC-V]: Atomic Extension (RV64A) locked. Memory consistency sharded.\n");
}
