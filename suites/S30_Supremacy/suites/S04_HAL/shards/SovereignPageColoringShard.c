...
sigma_u32 sigma_hal_page_color_assign(sigma_u64 phys_addr) {
    ...
    sigma_sigma_printf("[PAGE-COLORING]: Physical Address 0x%llX assigned to Cache Color %u.\n", 
...
void* sigma_hal_palloc_colored(sigma_u32 color) {
    sigma_sigma_printf("[PAGE-COLORING]: Allocating page for Shard-Domain with Color-ID: %u.\n", color);
...
void SovereignPageColoring_Register(void) {
    sigma_sigma_printf("[HAL]: Sovereign Page Coloring (Cache Harmony) active.\n");
}
