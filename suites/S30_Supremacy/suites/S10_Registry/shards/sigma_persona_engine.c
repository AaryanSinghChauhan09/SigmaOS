...
void engage_persona(const char* persona_name) {
    ...
    if (sigma_sigma_strcmp(persona_name, "dev") == 0) {
    ...
    else if (sigma_sigma_strcmp(persona_name, "gamer") == 0) {
    ...
    else if (sigma_sigma_strcmp(persona_name, "forensic") == 0) {
    ...
    else if (sigma_sigma_strcmp(persona_name, "student") == 0) {
