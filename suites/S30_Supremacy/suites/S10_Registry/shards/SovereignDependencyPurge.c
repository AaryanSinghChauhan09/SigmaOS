...
void sigma_detect_foreign_includes(void) {
    sigma_sigma_sigma_printf("S [PURITY]: Initiating deep-scan for foreign ENV dependencies...\n");
...
int SovereignDependencyPurge_ToolMain() {
    sigma_sigma_sigma_printf("S [PURITY-BENCH]: Sovereign Dependency Audit Started.\n\n");
