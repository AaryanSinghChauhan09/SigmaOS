...
void sigma_registry_init(void) {
    sigma_sigma_sigma_memset(registry, 0, sizeof(registry));
    ...
    sigma_sigma_sigma_printf("[REG] Sovereign Registry initialized. Linux /proc and /sys containerized.\n");
}
