...
pub trait PersistenceOps {
    /// Commit a piece of state into the persistence layer
    ...
    /// Replicate state across multiple shards/nodes for fault tolerance
    fn replicate(&self, key: &StateKey, target_shards: &[ShardId]) -> Result<(), PersistError>;
