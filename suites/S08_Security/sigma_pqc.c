 ...
 * Capability: Lattice-based Post-Quantum Cryptography (PQC) â€ native C11.
 * Principle: Zero-Library. Zero-OpenSSL. Direct Vector Math on Silicon.
 * Standard: C11 (ISO/IEC 9899:2011)
 * =========================================================================
 */

<<<<<<<< HEAD:suites/S08_Security/sigma_pqc.c
#include "../../include/libc/sigma_libc.h"
========
#include "../../include/libc/SovereignLibC.h"
>>>>>>>> ad8016503ce074e8980abb23e1a44b78be830645:kernel/shards/security/SovereignLatticePQC.c
...
static void pqc_init(SovereignLatticePQC* p) {
    sigma_memset(&p->shard, 0, sizeof(p->shard));
    p->key_id               = 0;
...
static void pqc_generate_key(SovereignLatticePQC* p) {
    ...
    sigma_memcpy(p->shard.pub_seed, &p->key_id, 8);
