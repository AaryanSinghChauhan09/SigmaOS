...
- [`src/compatibility/antix.rs`](file:///home/aaryansinghchauhan/SigmaOS/src/compatibility/antix.rs): antiX service manager, live USB persistence simulator, and lightweight package manager wrappers.
- [`src/init/sigma_init.rs`](file:///home/aaryansinghchauhan/SigmaOS/src/init/sigma_init.rs): Native zero-dependency init capable of microsecond process dispatch.
...
| **CLI Package Tools** | `cli-apt-i` | Native CLI package wizard in [`src/sigpkg/`](file:///home/aaryansinghchauhan/SigmaOS/src/sigpkg/) |
