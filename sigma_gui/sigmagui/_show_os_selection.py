"""
Auto-split from sigma_gui.py — SigmaGUI._show_os_selection
"""
...
class SigmaGUI:
    def _show_os_selection(self):
        ...
        for os_name, color in colors.items():
            b = tk.Button(btn_frame, text=os_name, font=('Segoe UI', 18, 'bold'), width=30, height=2, bg='#111111', fg=color, activebackground=color, activeforeground='#000000', relief='flat', command=lambda n=os_name: _boot('SigmaOS'))
            b.pack(pady=15)
        os_win.wait_window()
