"""
Auto-split from sigma_gui.py — SigmaGUI._build_nexus_ai_page
"""
...
class SigmaGUI:
    def _build_nexus_ai_page(self):
        ...
        tk.Label(card, text="The Sovereign AI Nexus is the 'Soul' of SigmaOS.\nIt manages high-level mission planning, system guidance, and security auditing.", font=FONT_MED, fg=PAL['dim'], bg=PAL['card'], justify='left').pack(anchor='w', pady=10)
        ...
        tk.Button(card, text='🚀 LAUNCH NEXUS AGENT (FULL)', bg=PAL['accent'], fg='white', font=FONT_BOLD, relief='flat', pady=12, command=lambda: self._launch_app('sigma.ai.nexus_ai')).pack(fill='x', pady=20)
