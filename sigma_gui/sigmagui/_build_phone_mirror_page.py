"""
Auto-split from sigma_gui.py — SigmaGUI._build_phone_mirror_page
"""
...
class SigmaGUI:
    def _build_phone_mirror_page(self):
        ...
        tk.Label(p, text='📱 SigmaMirror: Sovereign Mobile Integration', font=FONT_LOGO, fg=PAL['cyan'], bg=PAL['bg']).pack(anchor='w', pady=(0, 8))
        body = tk.Frame(p, bg=PAL['bg'])
        body.pack(fill='both', expand=True)
        screen_fr = tk.Frame(body, bg='black', width=360, height=720)
