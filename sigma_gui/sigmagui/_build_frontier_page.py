"""
Auto-split from sigma_gui.py — SigmaGUI._build_frontier_page
"""
...
class SigmaGUI:
    def _build_frontier_page(self):
        ...
        tk.Label(p, text='🔭  Sigma Frontier: Exponential Technology Lab', font=FONT_LOGO, fg=PAL['accent2'], bg=PAL['bg']).pack(anchor='w', pady=(0, 8))
