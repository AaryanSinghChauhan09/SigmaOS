"""
Auto-split from sigma_gui.py — SigmaGUI._build_forge_page
"""
...
class SigmaGUI:
    def _build_forge_page(self):
        ...
        self._pages['forge'] = p
        tk.Label(p, text='🎨  Content Forge: Sovereign Ingest & Audit', font=FONT_LOGO, fg=PAL['cyan'], bg=PAL['bg']).pack(anchor='w', pady=(0, 8))
