"""
Auto-split from sigma_gui.py — SigmaGUI._build_elite_page
"""
...
class SigmaGUI:
    def _build_elite_page(self):
        ...
        self._pages['elite'] = p
        tk.Label(p, text='🔱  Sigma Elite Ops: Ultimate Control Hub', font=FONT_LOGO, fg=PAL['accent'], bg=PAL['bg']).pack(anchor='w', pady=(0, 8))
