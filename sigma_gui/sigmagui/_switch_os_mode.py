"""
Auto-split from sigma_gui.py — SigmaGUI._switch_os_mode
"""
...
class SigmaGUI:
    def _switch_os_mode(self, event=None):
        ...
        preset_map = {'Gaming': 'Gaming_Apex', 'Editing': 'Editor_Studio', 'Automation': 'Automation_Overlord', 'Resource': 'Resource_Saver', 'Performance': 'Performance_Ultra'}
        ...
        color_map = {'Gaming': PAL['red'], 'Editing': PAL['purple'], 'Automation': PAL['cyan'], 'Resource': PAL['green'], 'Performance': PAL['accent']}
