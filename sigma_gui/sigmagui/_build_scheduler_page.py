"""
Auto-split from sigma_gui.py — SigmaGUI._build_scheduler_page
"""
...
class SigmaGUI:
    def _build_scheduler_page(self):
        ...
        tk.Button(controls, text='+ Schedule', bg=PAL['accent'], fg='white', relief='flat', command=lambda: self._log(sched_log, f'Scheduled: {name_e.get()} at {time_e.get()}', 'OK')).pack(side='left', padx=20)
