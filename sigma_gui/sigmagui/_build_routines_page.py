"""
Auto-split from sigma_gui.py — SigmaGUI._build_routines_page
"""
...
class SigmaGUI:
    def _build_routines_page(self):
        ...
        tk.Label(p, text='🎨  Forge Automator (Visual Scratch Builder)', font=FONT_LOGO, fg=PAL['cyan'], bg=PAL['bg']).pack(anchor='w', pady=(0, 8))
