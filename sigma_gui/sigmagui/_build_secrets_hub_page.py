"""
Auto-split from sigma_gui.py — SigmaGUI._build_secrets_hub_page
"""
...
class SigmaGUI:
    def _build_secrets_hub_page(self):
        ...
        tk.Label(p, text='🔐 Sovereign Secrets: Password & Passkey Hub', font=FONT_LOGO, fg=PAL['gold'], bg=PAL['bg']).pack(anchor='w', pady=(0, 8))
