"""
Auto-split from sigma_gui.py — SigmaGUI._build_linux_parity_page
"""
...
class SigmaGUI:
    def _build_linux_parity_page(self):
        ...
        metrics = [('Kernel Latency', 'Sigma: 4ns | Arch: 12ms', PAL['green']), ('Package Manager', 'Sigma: Apex Mesh | Arch: Pacman', PAL['cyan']), ('Security Model', 'Sigma: Zero-Trust | Arch: DAC/MAC', PAL['gold'])]
        ...
        tk.Label(v_card, text='SigmaHypervisor: Running Linux Binary Subsystem (LBS)...', font=FONT_SMALL, fg=PAL['text'], bg=PAL['bg2']).pack(pady=5)
