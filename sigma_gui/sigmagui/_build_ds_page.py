"""
Auto-split from sigma_gui.py — SigmaGUI._build_ds_page
"""
...
class SigmaGUI:
    def _build_ds_page(self):
        ...
        tk.Label(p, text='📊  Sigma Data Studio: Professional Data Engineering', font=FONT_LOGO, fg=PAL['cyan'], bg=PAL['bg']).pack(anchor='w', pady=(0, 8))
