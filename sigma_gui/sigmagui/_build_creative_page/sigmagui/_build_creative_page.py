"""
Auto-split from sigma_gui\sigmagui\_build_creative_page.py — SigmaGUI._build_creative_page
"""
...
class SigmaGUI:
    def _build_creative_page(self):
        ...
        tk.Label(p, text='🎨  Sigma Creative Hub: Professional Design Suite', font=FONT_LOGO, fg=PAL['accent2'], bg=PAL['bg']).pack(anchor='w', pady=(0, 8))
        ...
        macros = [('🎬 Cinema Mode', 'Cinema_Mode'), ('💼 Meeting Prep', 'Meeting_Sync'), ('🛌 Sleep Transition', 'Sleep_Guardian'), ('🎮 Gaming Link', 'Steam_Link'), ('🏠 All Power Off', 'Kill_All')]
