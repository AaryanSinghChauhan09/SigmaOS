"""
Auto-split from sigma_gui.py — SigmaGUI._build_mesh_page
"""
...
class SigmaGUI:
    def _build_mesh_page(self):
        ...
        self._pages['mesh'] = p
        tk.Label(p, text='🪐  Aura Mesh: Sovereign P2P Infrastructure', font=FONT_LOGO, fg=PAL['gold'], bg=PAL['bg']).pack(anchor='w', pady=(0, 8))
