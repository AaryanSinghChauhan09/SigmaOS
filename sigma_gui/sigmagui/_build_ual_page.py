"""
Auto-split from sigma_gui.py — SigmaGUI._build_ual_page
"""
...
class SigmaGUI:
    def _build_ual_page(self):
        ...
        self._pages['ual'] = p
        tk.Label(p, text='🌉  Universal Application Layer (UAL)', font=FONT_LOGO, fg=PAL['cyan'], bg=PAL['bg']).pack(anchor='w', pady=(0, 8))
        ...
        bridge_apps = [('Microsoft Photoshop (.exe)', 'photoshop.exe'), ('Apple Xcode (.app)', 'xcode.app'), ('Android WhatsApp (.apk)', 'whatsapp.apk'), ('Linux Blender (ELF)', 'blender')]
