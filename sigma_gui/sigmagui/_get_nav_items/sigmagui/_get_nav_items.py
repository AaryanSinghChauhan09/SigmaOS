"""
Auto-split from sigma_gui\sigmagui\_get_nav_items.py — SigmaGUI._get_nav_items
"""
...
class SigmaGUI:
    def _get_nav_items(self):
        ...
        if is_simple:
            return [('dashboard', '🏠', 'Home'), ('fabric', '🧠', 'Performance'), ('automator', '🦞', 'Easy Routines'), ('forge', '🎨', 'My Files'), ('mesh', '🪐', 'Network'), ('ual', '🌉', 'App Bridge'), ('security', '🛡️', 'Security'), ('manual', '📖', 'User Manual'), ('remote', '📱', 'Remote Hub'), ('terminal', '💻', 'Command Line'), ('law', '⚖️', 'Law Bridge'), ('buyhatke', '🛒', 'BuyHatke Pro'), ('writesense', '✍️', 'WriteSense Pro'), ('flow', '🌿', 'Flow Pro'), ('nexus', '🧬', 'AI Nexus'), ('war_room', '⚔️', 'War Room')]
        items = [('dashboard', '🏠', 'Playroom'), ('browser', '🌈', 'Magic Window'), ('explorer', '🧸', 'Toy Box'), ('gurukul_academy', '🎨', 'Fun School'), ('gaming_hub', '🎮', 'Happy Games'), ('intelligence_hub', '✨', 'Magic Thinking'), ('sovereign_suite', '⚽', 'Fun Stuff'), ('shopping_wizard', '🍭', 'Candy Shop'), ('wellness', '🛁', 'Nap Time'), ('config_hub', '🛡️', 'Safety Center')]
        guardian = self.kernel.registry.get('guardian')
        if guardian and guardian.is_child_mode():
            return items
        full_list = [('dashboard', '🏠', 'Home'), ('browser', '🌐', 'Browser'), ('explorer', '📁', 'Files'), ('gurukul_academy', '🎓', 'Gurukul'), ('gaming_hub', '🎮', 'Games'), ('sovereign_suite', '🧪', 'Suite'), ('shopping_wizard', '🛒', 'Shopping'), ('wellness', '🧘', 'Wellness'), ('config_hub', '⚙️', 'Settings'), ('projects', '📊', 'Projects'), ('nexus_ai', '🧬', 'AI Nexus'), ('store', '📦', 'Store'), ('antigravity_hub', '⚡', 'Antigravity'), ('dev_forge', '💻', 'Dev Forge'), ('sovereign_lab', '🔬', 'Sovereign Lab'), ('kernel_debug', '🐛', 'Kernel Debug'), ('gmail_ai', '📧', 'Gmail AI'), ('automation_hub', '🤖', 'Automation'), ('ai_lifecycle', '🧠', 'AI Mission'), ('zenith', '🚀', 'Zenith AI'), ('terminal', '💻', 'Terminal'), ('system_audit', '⚖️', 'Audit'), ('search', '🔍', 'Search'), ('law_pro', '⚖️', 'Lawyer'), ('buyhatke', '🛒', 'BuyHatke'), ('virtualbox', '🖥️', 'Virtual'), ('war_room', '⚔️', 'War Room'), ('mail_orchestrator', '📧', 'MailMerge'), ('sovereign_comms', '📡', 'Comms'), ('enterprise', '🚀', 'Business')]
        return full_list
