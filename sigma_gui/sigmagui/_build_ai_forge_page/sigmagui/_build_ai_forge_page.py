"""
Auto-split from sigma_gui\sigmagui\_build_ai_forge_page.py — SigmaGUI._build_ai_forge_page
"""
...
class SigmaGUI:
    def _build_ai_forge_page(self):
        ...
        tk.Label(p, text='🦾  Sigma AI Forge: ML & LLM Engineering Hub', font=FONT_LOGO, fg=PAL['accent'], bg=PAL['bg']).pack(anchor='w', pady=(0, 8))
        ...
        ttk.Button(exp_c, text='Start Experiment', command=lambda: self._log_voice(self.kernel.ai_lab.start_run('LLM_FineTune_V1', {'lr': 1e-05, 'batch': 32}))).pack(side='left', padx=5)
