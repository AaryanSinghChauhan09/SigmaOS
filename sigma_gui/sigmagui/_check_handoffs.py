"""
Auto-split from sigma_gui.py — SigmaGUI._check_handoffs
"""
...
class SigmaGUI:
    def _check_handoffs(self):
        ...
        tk.Button(notice, text='CONTINUE', font=FONT_BOLD, bg=PAL['accent'], fg='white', relief='flat', command=notice.destroy).pack(side='bottom', fill='x', pady=5, padx=10)
