"""
Auto-split from sigma_gui\sigmagui\_build_univ_hub_page.py — SigmaGUI._build_univ_hub_page
"""
...
class SigmaGUI:
    def _build_univ_hub_page(self):
        ...
        tk.Label(p, text='🌐  Sovereign Universal OS Hub: Cross-Platform Parity', font=FONT_LOGO, fg=PAL['cyan'], bg=PAL['bg']).pack(anchor='w', pady=(0, 8))
