"""
Auto-split from sigma_gui.py — SigmaGUI._build_aura_notes_page
"""
...
class SigmaGUI:
    def _build_aura_notes_page(self):
        ...
        tk.Label(p, text='📝 Aura Notes & Keeping Board', font=FONT_LOGO, fg=PAL['accent'], bg=PAL['bg']).pack(anchor='w', pady=(0, 8))
        nb = ttk.Notebook(p)
