# 🔊 Intel High Definition Audio (HDA) Controller Driver Blueprint
...
impl IntelHdaDriver {
    ...
    pub unsafe fn send_verb(&mut self, codec_id: u8, node_id: u8, verb: u32) -> Result<u64, &'static str> {
...
impl PeripheralDevice for IntelHdaDriver {
    ...
    fn initialize(&mut self) -> Result<(), &'static str> {
        ...
        unsafe {
            ...
            while (self.read_reg32(REG_GCTL) & 1) != 0 {
                core::hint::spin_loop();
            }
