...
| **Performance** | PREEMPT\_RT, MPI, Slurm | Single general scheduling | Real-Time kernel scheduler, HPC clustering |
...
1.  **Real-Time Kernel Variant**: PREEMPT\_RT implementation
...
*   [FUTURE-DEVELOPMENT-ROADMAP.md](FUTURE-DEVELOPMENT-ROADMAP) — Detailed strategic roadmap
*   [ARCHITECTURE.md](ARCHITECTURE) — System architecture overview
*   [SECURITY\_HARDENING\_COMPLETE.md](SECURITY_HARDENING_COMPLETE) — Complete security guide
*   [GAP\_CLOSING\_ROADMAP.md](GAP_CLOSING_ROADMAP) — Gap analysis vs Linux/BSD
*   [LINUX\_DISTRO\_PARITY\_ROADMAP.md](LINUX_DISTRO_PARITY_ROADMAP) — Linux distro parity strategy
*   [REPOS\_ABSORPTION\_PLAN.md](REPOS_ABSORPTION_PLAN) — Repository absorption strategy
