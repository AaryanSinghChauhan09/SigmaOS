...
pub mod package {
    ...
    pub struct AptDebManifest {
        ...
        pub priority: crate::universal_adapter::PackagePriority,
    }
}
...
fn test_universal_adapter_all_formats() {
    ...
    assert_eq!(pkg_bsd.version, crate::sigpkg::Version::new(7, 0, 11));
    ...
    assert_eq!(pkg_obsd.version, crate::sigpkg::Version::new(3, 3, 0));
...
fn test_all_prompt_package_formats() {
    use universal_adapter::{UniversalPackageAdapter, PackageFormat};
