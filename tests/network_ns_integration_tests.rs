...
mod network_ns_integration_tests {
    use sigmaos::net::{
        ...
        NetworkNamespaceManager, Route, VirtualBridge,
    };
    ...
    fn test_create_multiple_namespaces() {
        ...
        let ns3 = manager
            .create_namespace(Some(ns1))
            .expect("Failed to create ns3 (child of ns1)");
    ...
    fn test_create_interfaces_per_namespace() {
        ...
        ns1_lock
            .add_interface(eth0_ns1)
            .expect("Failed to add eth0 to ns1");
        ns1_lock
            .add_interface(eth1_ns1)
            .expect("Failed to add eth1 to ns1");
        ...
        ns2_lock
            .add_interface(eth0_ns2)
            .expect("Failed to add eth0 to ns2");

        // Verify isolation
        let ns1_ifaces = ns1_lock
            .list_interfaces()
            .expect("Failed to list ns1 ifaces");
        let ns2_ifaces = ns2_lock
            .list_interfaces()
            .expect("Failed to list ns2 ifaces");
    ...
    fn test_configure_routes_per_namespace() {
        ...
        ns1_lock
            .add_route(route1)
            .expect("Failed to add route1 to ns1");
        ns1_lock
            .add_route(route2)
            .expect("Failed to add route2 to ns1");
        ...
        ns2_lock
            .add_route(route3)
            .expect("Failed to add route to ns2");
        ...
        assert_eq!(
            ns1_routes[0].destination,
            IpAddr::V4(Ipv4Addr::new(10, 0, 0, 0))
        );
        assert_eq!(
            ns1_routes[1].destination,
            IpAddr::V4(Ipv4Addr::new(172, 16, 0, 0))
        );
        assert_eq!(
            ns2_routes[0].destination,
            IpAddr::V4(Ipv4Addr::new(192, 168, 0, 0))
        );
    }
    ...
    fn test_verify_network_isolation() {
        ...
        let eth0_ns1 = ns1_lock
            .get_interface("eth0")
            .expect("Failed to get eth0 from ns1");
        let eth0_ns2 = ns2_lock
            .get_interface("eth0")
    ...
    fn test_interface_visibility_isolation() {
        ...
        assert!(
            eth0_in_ns2.is_err(),
            "Interface should not be visible across namespaces"
        );
        ...
        assert!(
            eth0_in_ns1.is_ok(),
            "Interface should be visible in its namespace"
        );
    }
    ...
    fn test_route_isolation() {
        ...
        let route1 = Route::new(IpAddr::V4(Ipv4Addr::new(0, 0, 0, 0)), 0, "eth0".to_string());
        ns1_lock
            .add_route(route1)
            .expect("Failed to add default route to ns1");
        ...
        let route2 = Route::new(IpAddr::V4(Ipv4Addr::new(0, 0, 0, 0)), 0, "eth0".to_string());
        ns2_lock
            .add_route(route2)
            .expect("Failed to add route to ns2");
    ...
    fn test_bridge_connect_namespace() {
        ...
        ns1_lock
            .create_virtual_bridge("br0".to_string())
            .expect("Failed to create bridge");

        // Get bridge and connect namespaces
        let bridge_arc = ns1_lock
            .get_virtual_bridge("br0")
            .expect("Failed to get bridge");
        let mut bridge = bridge_arc.lock().expect("Failed to lock bridge");

        bridge
            .add_namespace(ns1_id)
            .expect("Failed to add ns1 to bridge");
        bridge
            .add_namespace(ns2_id)
            .expect("Failed to add ns2 to bridge");
        bridge
            .add_namespace(ns3_id)
            .expect("Failed to add ns3 to bridge");
    ...
    fn test_bridge_remove_namespace() {
        ...
        bridge
            .remove_namespace(ns1_id)
            .expect("Failed to remove ns1");
    ...
    fn test_three_namespace_communication_scenario() {
        ...
        ns3_lock
            .add_interface(eth0_ns3)
            .expect("Failed to add eth0 to ns3");
        ...
        ns1_lock
            .add_route(route1)
            .expect("Failed to add route to ns1");
    ...
    fn test_cross_namespace_isolation_at_socket_level() {
        ...
        let table1 = ns1_lock
            .get_socket_table()
            .expect("Failed to get socket table");
        let table2 = ns2_lock
            .get_socket_table()
            .expect("Failed to get socket table");
    ...
    fn bench_namespace_creation_latency() {
        ...
        assert!(
            avg_us < 1000.0,
            "Namespace creation too slow: {:.2} µs",
            avg_us
        );
    }
    ...
    fn bench_interface_creation_latency() {
        ...
        assert!(
            avg_us < 100.0,
            "Interface creation too slow: {:.2} µs",
            avg_us
        );
    }
    ...
    fn bench_firewall_rule_matching_performance() {
        ...
        for i in 0..100 {
            let rule = FirewallRule::new(if i % 2 == 0 {
    ...
    fn test_route_conflicts() {
        ...
        ns_lock
            .add_route(route1)
            .expect("Failed to add first route");
    ...
    fn test_bridge_duplicate_namespace_prevented() {
        ...
        assert!(
            result.is_err(),
            "Should prevent duplicate namespace in bridge"
        );
    }
