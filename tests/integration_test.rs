...
use sigmaos::kernel::{
    ...
    InstructionCyclePhase, InterruptClass, IoWaitProfile, Irql, KernelMechanism, KernelPolicy,
    LcgRandom, LookasideList, LotteryTask, MemoryDescriptorList, Pcb, PolicyMechanismCoordinator,
    PoolType, Priority, Process, ProcessState, ProcessorInitState, SequencedSinglyLinkedList,
    SinglyLinkedList, SovereignMechanism, SystemThread, Tcb, ThreadState, WorkItem,
};
...
mod tests {
    ...
    use sigmaos::FileType;
    use sigmaos::VirtualFilesystem;
    use sigmaos::sigpkg::universal_oop_system::PackageFormat;
    use sigmaos::crash::{CrashPipeline, Anonymizer};
    use sigmaos::sigpkg::universal_oop_system::IPackageParser;
    ...
    fn test_system_integration() {
        ...
        let mut wine = ZorinWineLayer::new();
    ...
    fn test_multi_distro_packaging_compatibility() {
        ...
        assert_eq!(ebuild.format(), PackageFormat::Ebuild);
    }
