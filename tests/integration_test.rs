...
use sigmaos::compatibility::{
    ...
    AntixDesktopProfiler, AntixInitManager, BinaryCompatMatrix, BsdJailSandbox, BundleType,
    CompatBinary, CompatBinaryFormat, CompatibilityLayer, ContinuityCoordinator, DesktopMode,
    DesktopProfile as AntixDesktopProfile, DesktopTheme, DiscontinuedFS, DriverBridge,
    ...
    LegacyPluginManager, LibcVersion, MicroService, MicroService as AntixMicroService,
    MicroServiceState, MicroServiceState as AntixMicroServiceState, NetworkBridge, SnapshotManager,
    StorageBridge, SyscallAbi, TribeInstaller, UnifiedAppStore, WorkloadOptimizer, WorkloadProfile,
...
mod tests {
    ...
    fn test_snapshot_rollback_system() {
        ...
        let snap1 = manager.create_snapshot("Before update experiment");
        assert_eq!(snap1, 1);
    ...
    fn test_ai_assisted_scheduling() {
        ...
        // Trigger thermal throttling throttling time slice to 4ms
