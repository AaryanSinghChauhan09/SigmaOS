...
mod tests {
    ...
    fn test_system_integration() {
        ...
        zorin_app.switch_mode(DesktopMode::TouchTabletMode);
        assert!(!zorin_app.compositor_animations_enabled);
    ...
    fn test_multi_distro_packaging_compatibility() {
        ...
        use sigmaos::sigpkg::universal_oop_system::{IPackageParser, PackageFormat};
