...
- **Absorbed Features & Algorithms**: Wayland wl_roots compositor protocols, i3 tile-tree geometry algorithms, Sway gesture input handlers, KDE Plasma QML desktop widgets.
