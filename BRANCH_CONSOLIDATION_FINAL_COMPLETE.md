...
1. **KLIB_REFERENCE.md** - Comprehensive reference for the SigmaOS kernel library
2. **LINUX_BSD_INNOVATIONS_IMPLEMENTED.md** - Tracks all Linux and BSD innovations implemented
3. **SECURITY_HARDENING_COMPLETE.md** - Complete security hardening guide
4. **SYSCALL_TABLE.md** - System call table documentation
5. **ZERO_DEPENDENCY_ARCHITECTURE.md** - Zero-dependency architecture documentation
...
- eBPF-based sched_ext hot-swappable scheduler
