...
| **Rust (no\_std)**      | Kernel subsystems, userland daemons, sigpkg       | Memory-safe, zero-cost, no GC, no runtime                         |
...
| **NASM / AT\&T ASM**    | CPU boot stubs, ISR entry points                  | Required for x86\_64/AArch64 bare-metal startup                    |
