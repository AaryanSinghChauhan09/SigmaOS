...
2. **Ignition**: Boot and select "Web Shard Deployment".

3. **Connectivity**: Log in to Wi-Fi/Ethernet during the ASI sequence.

4. **Login**: Authenticate with your Sovereign ID or stay anonymous in "Guest Shard" mode.
