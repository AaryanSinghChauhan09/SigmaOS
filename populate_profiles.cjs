...
const additionalProfessions = [
    ...
    'Orbital Habitat Architect', 'Neural-Link Security Auditor', 'Deep-Sea Mining Coordinator', 'Asteroid Prospector',
    ...
    'Space Elevator Engineer', 'Off-World Terraformer', 'Intergalactic Diplomat', 'Dark Matter Researcher',
    'Quantum Teleportation Specialist', 'Holographic Projection Technician', 'Cyborg Ethics Board Member', 'Sentient AI Rights Advocate',
    'Asteroid Mining Driller', 'Zero-Gravity Manufacturing Specialist', 'Exo-Planet Meteorologist', 'Deep Space Telescope Operator',
    'Hyperloop Maintenance Technician', 'Magnetic Levitation Track Inspector', 'Neural Enhancement Surgeon', 'Bionic Limb Prosthetist',
    'Memory Editing Therapist', 'Virtual Reality Rehabilitation Specialist', 'Genomic Sequencing Analyst', 'Crispr Gene Editing Technician',
    'Personalized Medicine Pharmacologist', 'Bio-Informatics Software Engineer', 'Longevity Research Scientist', 'Cryogenics Facility Manager',
    'Nanobot Swarm Controller', 'Molecular Assembler Technician', 'Smart Dust Deployment Strategist', 'Quantum Cryptography Analyst',
    'Post-Quantum Network Architect', 'Blockchain Governance Protocol Developer', 'Decentralized Autonomous Organization Manager', 'Non-Fungible Token Curator',
    'Metaverse Real Estate Agent', 'Digital Avatar Fashion Designer', 'Virtual Event Coordinator', 'Haptic Feedback System Designer',
    'Brain-Computer Interface Programmer', 'Cognitive Enhancement Tutor', 'Emotional Intelligence AI Trainer', 'Synthetic Empathy Programmer',
    'Automated Journalism Algorithm Editor', 'Deepfake Detection Specialist', 'Algorithmic Bias Auditor', 'Ethical AI Certification Officer',
    'Robot Swarm Choreographer', 'Autonomous Drone Delivery Fleet Manager', 'Robo-Taxi Dispatcher', 'Automated Warehouse Logistics Coordinator',
    '3D Printed Organ Transplant Coordinator', 'Bio-Fabrication Facility Operator',
    'Indian Lawyer', 'Chartered Accountant', 'Software Developer', 'Data Scientist', 'AI Engineers', 'Cloud Architect', 
    'Cybersecurity Analyst', 'DevOps Engineer', 'Embedded Systems Engineer', 'Game Developer', 'Web Developer', 
    'Mobile App Developer', 'Project Manager', 'Business Analyst', 'Product Manager', 'Financial Analyst', 
    'Auditor', 'HR Manager', 'Operations Manager', 'Supply Chain Analyst', 'Compliance Officer', 
    'Doctor', 'Nurse', 'Pharmacist', 'Medical Researcher', 'Biotechnologist', 'Geneticist', 'Radiologist', 
    'Public Health Official', 'Clinical Trial Manager', 'Healthcare Administrator', 'Graphic Designer', 
    'Video Editor', 'Animator', 'Photographer', 'Music Producer', 'Writer', 'Journalist', 'Content Creator', 
    'UX/UI Designer', 'Marketing Specialist', 'Physicist', 'Chemist', 'Mathematician', 'Statistician', 
    'Astronomer', 'Environmental Scientist', 'Geologist', 'Oceanographer', 'Social Scientist', 'Economist', 
    'Lawyer', 'Judge', 'Policymaker', 'Civil Servant', 'Diplomat', 'Military Officer', 'Intelligence Analyst', 
    'Forensic Expert', 'Tax Official', 'Urban Planner', 'Teacher', 'Professor', 'Curriculum Designer', 
    'Educational Researcher', 'Instructional Designer', 'E-Learning Specialist', 'School Administrator', 
    'Librarian', 'Language Instructor', 'Vocational Trainer', 'Mechanical Engineer', 'Electrical Engineer', 
    'Civil Engineer', 'Chemical Engineer', 'Industrial Designer', 'Quality Assurance Specialist', 
    'Robotics Engineer', 'Automotive Engineer', 'Aerospace Engineer', 'Energy Analyst', 'Blockchain Developer', 
