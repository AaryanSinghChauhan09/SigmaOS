...
/**
 * ÃŽÂ£ SIGMA OS: SOVEREIGN ENCYCLOPEDIA (v128.0 - ZERO-STD NATIVE)
 * ===================================================================
...
public:
    void Project() override {
        ...
        sigma_log_info("[PHYSICS/ENCY]: Concept: Magnetic Field (B) near wire.\n");
        sigma_log_info("[PHYSICS/ENCY]: B Shard: %f Tesla.\n", B);
    }
};
...
public:
    void Project() override {
        ...
        sigma_log_info("[PHYSICS/ENCY]: Concept: Projectile Range (v=20m/s, 45deg).\n");
        sigma_log_info("[PHYSICS/ENCY]: Range Shard: %f Meters.\n", range);
    }
};
...
public:
    void Project() override {
        sigma_log_info("[BIOLOGY/ENCY]: Concept: Natural Selection (Darwin Shard).\n");
        sigma_log_info("[BIOLOGY/ENCY]: Survival of the Fittest (Adaptivity = 100%%).\n");
    }
};
...
public:
    void Project() override {
        sigma_log_info("[CHEMISTRY/ENCY]: Concept: HCl + NaOH -> NaCl + H2O.\n");
        sigma_log_info("[CHEMISTRY/ENCY]: Exothermic Shard: Delta-H detected.\n");
    }
};
...
public:
    void Project() override {
        ...
        sigma_log_info("[MATH/ENCY]: Concept: Power Set: P(S) cardinality for |S|=3.\n");
        sigma_log_info("[MATH/ENCY]: Card(P(S)) = %d (Shard-Perfect).\n", p);
    }
};
...
public:
    ...
    void ExecuteEncycloAudit() {
        sigma_log_info("--- ÃŽÂ£ SIGMA OS MASTER SCHOLASTIC ENCYCLOPEDIA ---\n");
