...
## 🛠️ Current Driver Status

| Shard | Subsystem | Hardware | Status |
| :--- | :--- | :--- | :--- |
| `SovereignVGA` | Display | VGA / VESA LFB | **STABLE** |
| `SovereignPS2` | Input | PS/2 Keyb/Mouse | **STABLE** |
| `SovereignATA` | Storage | IDE / PATA | **STABLE** |
| `SovereignE1000`| Network | Intel 8254x (QEMU) | **BETA** |
| `SovereignAHCI` | Storage | SATA / SSD | **BETA** |

## 🚀 Driver Roadmap (Priority)
...
---
*To contribute a driver, see [CONTRIBUTING.md](../CONTRIBUTING.md).*
