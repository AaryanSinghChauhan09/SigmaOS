...
The current SigmaOS v81.0 architecture consists of the following master shards:
...
| Feature           | Linux Enterprise (RHEL)        | SigmaOS Sovereign (v81.0)       |
| ----------------- | ------------------------------ | ------------------------------- |
