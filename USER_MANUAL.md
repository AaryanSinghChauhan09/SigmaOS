...
The current SigmaOS v72.0 architecture consists of the following master shards:
...
| Feature           | Linux Enterprise (RHEL)        | SigmaOS Sovereign (v72.0)       |
| ----------------- | ------------------------------ | ------------------------------- |
