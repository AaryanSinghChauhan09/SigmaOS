...
The current SigmaOS v49.0 architecture consists of the following master shards:
...
| Feature           | Linux Enterprise (RHEL)        | SigmaOS Sovereign (v49.0)       |
| ----------------- | ------------------------------ | ------------------------------- |
