...
The current SigmaOS v41.0 architecture consists of the following master shards:
...
| Feature           | Linux Enterprise (RHEL)        | SigmaOS Sovereign (v41.0)       |
| ----------------- | ------------------------------ | ------------------------------- |
