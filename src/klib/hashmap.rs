...
impl<K: core::hash::Hash + Eq + Clone, V: PartialEq + Clone> PartialEq for BTreeMap<K, V> {
...
impl<K: core::hash::Hash + PartialEq + Clone + Eq, V: PartialEq + Clone + Eq> Eq for BTreeMap<K, V> {}
