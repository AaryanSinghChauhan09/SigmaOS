...
/// Kali Linux-inspired: Active/passive reconnaissance and OS fingerprinting engine
#[derive(Debug, Clone)]
...
pub struct KaliSnoopAnalysis {
    ...
    scan_history: HashMap<IpAddr, Vec<u16>>,
}
...
impl SecurityAnalysis {
    pub fn new(max_attempts: u32) -> Self {
        Self {
            ...
            suspicious_ports: vec![22, 23, 80, 443, 3389],
            max_attempts,
        }
    }
}
...
mod tests {
    ...
    fn test_alpine_zero_alloc_capture_buffer() {
        ...
        assert_eq!(packets[0].source_port, 12346);
        assert_eq!(packets[1].source_port, 12347);
        assert_eq!(packets[2].source_port, 12348);
    ...
    #[test]
    fn test_nix_declarative_filter() {
    ...
    fn test_clear_linux_flow_load_balancer() {
        let mut lb = ClearLinuxFlowLoadBalancer::new(4);
