...
impl CgroupManager {
    ...
    /// Create a new cgroup
    pub fn create_cgroup(&mut self, name: String, path: String, parent: Option<String>) -> Result<(), &'static str> {
    ...
    pub fn enable_subsystem(&mut self, path: &str, subsystem: CgroupSubsystem) -> Result<(), &'static str> {
    ...
    pub fn set_parameter(&mut self, path: &str, subsystem: CgroupSubsystem, key: String, value: String) -> Result<(), &'static str> {
        let cgroup = self.cgroups.get_mut(path)
            .ok_or("Cgroup not found")?;

        let controller = cgroup.subsystems.get_mut(&subsystem)
    ...
    pub fn get_parameter(&self, path: &str, subsystem: CgroupSubsystem, key: &str) -> Option<&String> {
...
mod tests {
    ...
    fn test_create_cgroup() {
        ...
        manager.create_cgroup("root".to_string(), "/".to_string(), None).unwrap();
    ...
    fn test_enable_subsystem() {
        ...
        manager.create_cgroup("test".to_string(), "/test".to_string(), None).unwrap();
        manager.enable_subsystem("/test", CgroupSubsystem::Cpu).unwrap();
    ...
    fn test_set_parameter() {
        ...
        manager.create_cgroup("test".to_string(), "/test".to_string(), None).unwrap();
        manager.enable_subsystem("/test", CgroupSubsystem::Cpu).unwrap();
        manager.set_parameter("/test", CgroupSubsystem::Cpu, "shares".to_string(), "1024".to_string()).unwrap();
    ...
    fn test_delete_cgroup() {
        ...
        manager.create_cgroup("root".to_string(), "/".to_string(), None).unwrap();
        manager.create_cgroup("child".to_string(), "/child".to_string(), Some("/".to_string())).unwrap();
    ...
    fn test_multiple_subsystems() {
        ...
        manager.create_cgroup("test".to_string(), "/test".to_string(), None).unwrap();
        manager.enable_subsystem("/test", CgroupSubsystem::Cpu).unwrap();
        manager.enable_subsystem("/test", CgroupSubsystem::Memory).unwrap();
        manager.enable_subsystem("/test", CgroupSubsystem::Ios).unwrap();
