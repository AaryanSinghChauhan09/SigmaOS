...
impl SovereignDynamicDevfsEngine {
    pub fn new() -> Self {
        ...
        devfs.register_device_node("null", DeviceNodeType::CharacterDevice, 1, 3);
        devfs.register_device_node("zero", DeviceNodeType::CharacterDevice, 1, 5);
        devfs.register_device_node("sda", DeviceNodeType::BlockDevice, 8, 0);
        devfs
    }
