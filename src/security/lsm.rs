...
pub const CAP_NET_BIND_SERVICE_BIT: u64 = 1 << 10;
...
pub const CAP_SYS_CHROOT_BIT: u64 = 1 << 18;
pub const CAP_SYS_PTRACE_BIT: u64 = 1 << 19;
pub const CAP_SYS_PACCT: u64 = 1 << 20;
pub const CAP_SYS_ADMIN_BIT: u64 = 1 << 21;
