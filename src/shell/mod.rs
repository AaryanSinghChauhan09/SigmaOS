...
pub use sigma_sh::{
    ...
    SovereignSigmaShRepl, ZshPromptFormatter, ShellSyntaxHighlighter,
};
...
pub use zsh_bash_parity::{
    ...
    WildcardGlobMatcher, ZshSyntaxHighlighter, PromptTheme, CompletionCandidate, CandidateCategory,
    SyntaxTokenKind, HighlightedToken, ShellPipelineParser, ShellPipeline, PipelineCommand,
    ShellJob, JobState,
};
