...
pub enum KeyCode {
    ...
    Num7Kp, Num8Kp, Num9Kp, NumPlus,
    Num4Kp, Num5Kp, Num6Kp,
    Num1Kp, Num2Kp, Num3Kp, NumEnter,
    Num0Kp, NumDot,
...
pub fn scancode_to_key(code: u8) -> (KeyCode, KeyEventKind) {
    ...
    let make = code & 0x7F;
    let key = match make {
        0x01 => KeyCode::Escape,   0x02 => KeyCode::Num1,
        0x03 => KeyCode::Num2,     0x04 => KeyCode::Num3,
        0x05 => KeyCode::Num4,     0x06 => KeyCode::Num5,
        0x07 => KeyCode::Num6,     0x08 => KeyCode::Num7,
        0x09 => KeyCode::Num8,     0x0A => KeyCode::Num9,
        0x0B => KeyCode::Num0,     0x0C => KeyCode::Minus,
        0x0D => KeyCode::Equals,   0x0E => KeyCode::Backspace,
        0x0F => KeyCode::Tab,      0x10 => KeyCode::Q,
        0x11 => KeyCode::W,        0x12 => KeyCode::E,
        0x13 => KeyCode::R,        0x14 => KeyCode::T,
        0x15 => KeyCode::Y,        0x16 => KeyCode::U,
        0x17 => KeyCode::I,        0x18 => KeyCode::O,
        0x19 => KeyCode::P,        0x1C => KeyCode::Enter,
        0x1D => KeyCode::LCtrl,    0x1E => KeyCode::A,
        0x1F => KeyCode::S,        0x20 => KeyCode::D,
        0x21 => KeyCode::F,        0x22 => KeyCode::G,
        0x23 => KeyCode::H,        0x24 => KeyCode::J,
        0x25 => KeyCode::K,        0x26 => KeyCode::L,
        0x2A => KeyCode::LShift,   0x2C => KeyCode::Z,
        0x2D => KeyCode::X,        0x2E => KeyCode::C,
        0x2F => KeyCode::V,        0x30 => KeyCode::B,
        0x31 => KeyCode::N,        0x32 => KeyCode::M,
        0x36 => KeyCode::RShift,   0x38 => KeyCode::LAlt,
        0x39 => KeyCode::Space,    0x3A => KeyCode::CapsLock,
...
impl Ps2Controller {
    ...
    pub fn process_scancode(&mut self, scancode: u8) {
        ...
        match (&key, &kind) {
            (KeyCode::LShift, KeyEventKind::Press)   | (KeyCode::RShift, KeyEventKind::Press)   => self.shift_held = true,
            (KeyCode::LShift, KeyEventKind::Release) | (KeyCode::RShift, KeyEventKind::Release) => self.shift_held = false,
            (KeyCode::LCtrl, KeyEventKind::Press)    | (KeyCode::RCtrl, KeyEventKind::Press)    => self.ctrl_held = true,
            (KeyCode::LCtrl, KeyEventKind::Release)  | (KeyCode::RCtrl, KeyEventKind::Release)  => self.ctrl_held = false,
            (KeyCode::LAlt, KeyEventKind::Press)     | (KeyCode::RAlt, KeyEventKind::Press)     => self.alt_held = true,
            (KeyCode::LAlt, KeyEventKind::Release)   | (KeyCode::RAlt, KeyEventKind::Release)   => self.alt_held = false,
            _ => {}
        }
    ...
    pub fn poll_key(&mut self) -> Option<KeyEvent> { self.key_events.pop_front() }
    ...
    pub fn scancode_count(&self) -> usize { self.scancode_count.load(Ordering::Relaxed) }
}

impl KernelSubsystem for Ps2Controller {
    fn name(&self) -> &str { "ps2_controller" }
    fn version(&self) -> &str { "2.0.0" }
    fn init_order(&self) -> InitOrder { InitOrder::CoreKernel }
