...
impl UniversalDependencyMapper {
    ...
    pub fn to_canonical_name(&self, foreign_name: &str) -> String {
        ...
        match clean {
            ...
            | "x11-proto/xorgproto"
            | "libx11-dev"
            | "libx11-devel" => "libx11".to_string(),
            "wayland" | "dev-libs/wayland" | "wayland-protocols" | "dev-libs/wayland-protocols" => {
                "wayland".to_string()
            }
            "pipewire" | "media-video/pipewire" | "pipewire-media-session" => {
                "pipewire".to_string()
            }
            "dbus" | "sys-apps/dbus" | "dbus-devel" | "dbus-dev" => "dbus".to_string(),
            "pkgconf" | "pkg-config" | "dev-util/pkgconf" | "pkgconfig" => "pkgconf".to_string(),
            "ncurses" | "ncursesw" | "libncurses-dev" | "ncurses-devel" | "sys-libs/ncurses" => {
                "ncurses".to_string()
            }
            "readline" | "libreadline-dev" | "readline-devel" | "sys-libs/readline" => {
                "readline".to_string()
            }
            "xz" | "xz-utils" | "liblzma-dev" | "xz-devel" | "app-arch/xz-utils" => {
                "xz".to_string()
            }
            ...
            "libffi" | "libffi-dev" | "libffi-devel" | "devel/libffi" | "dev-libs/libffi" => {
                "libffi".to_string()
            }
            "glib" | "glib2" | "libglib2.0-dev" | "glib2-devel" | "devel/glib2"
            | "dev-libs/glib" => "glib".to_string(),
            "pcre" | "pcre2" | "libpcre3-dev" | "libpcre2-dev" | "pcre-devel" | "pcre2-devel"
            | "devel/pcre2" | "dev-libs/libpcre2" => "pcre".to_string(),
            "libuv" | "libuv1-dev" | "libuv-devel" | "devel/libuv" | "dev-libs/libuv" => {
                "libuv".to_string()
            }
            "openssh" | "openssh-server" | "openssh-clients" | "net/openssh"
            | "net-misc/openssh" => "openssh".to_string(),
            "mesa" | "mesa-dev" | "mesa-libgl-devel" | "graphics/mesa-libs" | "media-libs/mesa" => {
                "mesa".to_string()
            }
            "freetype"
            | "freetype2"
            ...
            | "freetype-devel"
            | "print/freetype2"
            | "media-libs/freetype" => "freetype".to_string(),
            "fontconfig"
            | "libfontconfig1-dev"
            | "fontconfig-devel"
            | "x11-fonts/fontconfig"
            | "media-libs/fontconfig" => "fontconfig".to_string(),
            "ffmpeg" | "ffmpeg-dev" | "ffmpeg-devel" | "multimedia/ffmpeg"
            | "media-video/ffmpeg" => "ffmpeg".to_string(),
