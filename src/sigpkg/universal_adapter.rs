...
impl UniversalDependencyMapper {
    ...
    pub fn to_canonical_name(&self, foreign_name: &str) -> String {
        ...
        match clean {
            ...
            "ffmpeg" | "ffmpeg-devel" | "multimedia/ffmpeg" | "media-video/ffmpeg" => "ffmpeg".to_string(),
            ...
            "libbsd" | "libbsd-dev" | "libbsd-devel" | "devel/libbsd" => "libbsd".to_string(),
            "sndio" | "audio/sndio" | "media-sound/sndio" => "sndio".to_string(),
            "alsa-lib" | "alsa" | "media-libs/alsa-lib" | "audio/alsa-lib" => "alsa-lib".to_string(),
            "pulseaudio" | "libpulse" | "media-sound/pulseaudio" | "audio/pulseaudio" => "pulseaudio".to_string(),
            "vulkan-loader" | "vulkan" | "media-libs/vulkan-loader" | "graphics/vulkan-loader" => "vulkan".to_string(),
            "mesa" | "mesa-dri-drivers" | "media-libs/mesa" | "graphics/mesa-libs" => "mesa".to_string(),
            "libdrm" | "x11-libs/libdrm" | "graphics/libdrm" => "libdrm".to_string(),
            "bzip2" | "bzip2-devel" | "app-arch/bzip2" | "archivers/bzip2" => "bzip2".to_string(),
            "lz4" | "liblz4-dev" | "app-arch/lz4" | "archivers/lz4" => "lz4".to_string(),
            "zsh" | "shells/zsh" | "app-shells/zsh" => "zsh".to_string(),
            "fish" | "shells/fish" | "app-shells/fish" => "fish".to_string(),
            "tcsh" | "csh" | "shells/tcsh" => "tcsh".to_string(),
            "wireguard" | "wireguard-tools" | "net-vpn/wireguard-tools" => "wireguard".to_string(),
...
impl UniversalPmCommandDispatcher {
    ...
    pub fn dispatch_command(&self, full_cmd: &str) -> Result<DispatchedPmAction, &'static str> {
        ...
        match pm.as_str() {
            ...
            "pacman" | "yay" | "paru" | "pikaur" | "trizen" | "aura" | "arch" | "manjaro" | "cachy" | "cachyos" => {
                ...
                while i < args.len() {
                    match args[i] {
                        ...
                        "-Si" | "-Qi" | "info" | "query" => operation = UniversalPmOperation::QueryInfo,
            ...
            "dnf" | "yum" | "microdnf" | "rpm" | "fedora" | "rhel" | "centos" | "zypper" | "opensuse" | "suse" => {
                let mut i = 0;
                while i < args.len() {
                    match args[i] {
...
"#;
    ...
    fn test_expanded_cross_distro_command_dispatch_and_dependency_mapping() {
        ...
        let debian = dispatcher.dispatch_command("debian install git-core").unwrap();
        ...
        assert_eq!(dep_mapper.to_canonical_name(&debian.target_packages[0]), "git");

        let arch = dispatcher.dispatch_command("arch -S --dryrun ffmpeg-devel").unwrap();
        ...
        let freebsd = dispatcher.dispatch_command("freebsd install -n lang/gcc").unwrap();
        ...
        let void = dispatcher.dispatch_command("void install sys-apps/ripgrep").unwrap();
