...
impl AurRecipeCompiler {
    ...
    pub fn compile_pkgbuild(&self, pkgbuild_content: &str) -> Result<Package, &'static str> {
        ...
        Ok(Package::new(
            crate::klib::string::SigmaString::from_str(pkgname),
            parsed_ver,
            crate::klib::string::SigmaString::from_str(&format!("Compiled AUR Package: {}", pkgname)),
            depends,
            crate::klib::string::SigmaString::from_str("sha256_compiled_mock_hash_value"),
        ))
    }
}
...
impl PacmanDbAdapter {
    ...
    pub fn import_legacy_pacman_package(
        ...
        Ok(Package::new(
            crate::klib::string::SigmaString::from_str(name),
            parsed_ver,
            crate::klib::string::SigmaString::from_str(desc),
            alloc::vec::Vec::new(),
            crate::klib::string::SigmaString::from_str("sha256_imported_legacy_hash_value"),
        ))
    }
}
