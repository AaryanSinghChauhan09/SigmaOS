...
mod tests {
    ...
    fn test_aur_pkgbuild_compiler() {
        ...
        assert_eq!(package.name, crate::klib::string::SigmaString::from("neo-vim"));
        assert_eq!(package.version, Version::new(0, 9, 1));
        assert_eq!(package.dependencies.len(), 3);
        assert_eq!(package.dependencies[0].name, crate::klib::string::SigmaString::from("libc"));
    }
    ...
    fn test_rolling_upgrade_sync() {
        ...
        assert_eq!(pending[0].0, crate::klib::string::SigmaString::from("bash"));
    ...
    fn test_legacy_pacman_db_import() {
        ...
        assert_eq!(imported.name, crate::klib::string::SigmaString::from("pacman-contrib"));
        assert_eq!(imported.version, Version::new(1, 8, 0));
        assert_eq!(
            imported.description,
            crate::klib::string::SigmaString::from("Contrib utilities for pacman package manager")
        );
    }
    ...
    fn test_makepkg_builder() {
        ...
        assert_eq!(pkg_file, crate::klib::string::SigmaString::from("ripgrep-13.0.0-x86_64.pkg.tar.zst"));
