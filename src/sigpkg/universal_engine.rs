...
impl PackageFormat {
    pub fn from_filename(filename: &str) -> Option<Self> {
        ...
        else if lower.ends_with(".nixpkg") || lower.ends_with(".nix") { Some(PackageFormat::Nix) }
        ...
        else if lower.ends_with(".pkg.tar.zst") || lower.ends_with(".pkg.tar.xz") { Some(PackageFormat::Pacman) }
        else if lower.ends_with(".xz") || lower.ends_with(".tar.xz") { Some(PackageFormat::TarXz) }
