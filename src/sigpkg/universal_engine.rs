...
impl PackageFormat {
    pub fn from_filename(filename: &str) -> Option<Self> {
        ...
        else if normalized.ends_with(".sigpkg") || normalized.ends_with(".sigma") { Some(PackageFormat::Sovereign) }
        ...
        else if normalized.ends_with(".nixpkg") || normalized.ends_with(".nix") { Some(PackageFormat::Nix) }
        ...
        else if normalized.ends_with(".txz") || normalized.ends_with(".tar.xz") || normalized.ends_with(".xz") { Some(PackageFormat::TarXz) }
        ...
        else if normalized.ends_with(".commit") || normalized.ends_with(".ostree") { Some(PackageFormat::Ostree) }
        ...
        else if normalized.ends_with(".cachy") || normalized.ends_with(".cachyos") { Some(PackageFormat::Pacman) }
        else if normalized.ends_with(".dports") { Some(PackageFormat::Dports) }
        else if name.ends_with(".slackbuild") || name.ends_with(".tlz") || name.ends_with(".tbz") { Some(PackageFormat::SlackBuild) }
        ...
        else if normalized.ends_with(".app") { Some(PackageFormat::AppBundle) }
        ...
        else if normalized.ends_with(".pup") { Some(PackageFormat::Pup) }
        else if normalized.ends_with(".pet") { Some(PackageFormat::Pet) }
        ...
        else if normalized.ends_with(".whl") { Some(PackageFormat::Wheel) }
