...
impl SigmaOdfPackageEngine {
    ...
    pub fn assemble_odf_archive_bytes(&self) -> Vec<u8> {
        ...
        match self.kind {
            OdfDocumentKind::TextOdt => bytes.extend_from_slice(b"application/vnd.oasis.opendocument.text"),
            OdfDocumentKind::SpreadsheetOds => bytes.extend_from_slice(b"application/vnd.oasis.opendocument.spreadsheet"),
            OdfDocumentKind::PresentationOdp => bytes.extend_from_slice(b"application/vnd.oasis.opendocument.presentation"),
        };
