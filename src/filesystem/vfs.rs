...
/// File permissions with POSIX SUID/SGID/Sticky bits and octal mode support
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub struct FilePermissions {
    ...
    pub sgid: bool,
    pub sticky: bool,
    pub owner_mask: u8, // rwx (3 bits)
    pub group_mask: u8, // rwx (3 bits)
    pub other_mask: u8, // rwx (3 bits)
}
...
impl FilePermissions {
    ...
    pub fn all() -> Self {
        Self::from_mode_bits(0o777)
    }

    pub fn read_only() -> Self {
        Self::from_mode_bits(0o444)
    }
}
