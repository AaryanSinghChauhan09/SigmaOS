...
// Enables support for all legacy, dropped, and custom hardware peripherals since 1981 (e.g. NE2000, LPT, Floppy, PS/2).
...
pub enum DeviceGeneration {
    LegacyISA = 0,  // 1980s (Serial, Parallel, Floppy, NE2000)
    ClassicPCI = 1, // 1990s (PCI Ethernet, SoundBlaster16)
...
// Implement standard SigmaOS Device traits for our Legay Peripheral Adapter
...
impl HardwareAutoNegotiationBroker {
    pub fn new() -> Self {
        HardwareAutoNegotiationBroker {
            registered_legacy_ports: vec![0x3F8, 0x2F8, 0x378, 0x300], // COM1, COM2, LPT1, NE2000 defaults
        }
    }
