...
impl PackageFactory {
    pub fn get_strategy(format: PackageFormat) -> Box<dyn InstallStrategy> {
        match format {
            ...
            PackageFormat::OpenBsdPkg | PackageFormat::SolarisIps => Box::new(PkgInstallStrategy),
    ...
    pub fn get_adapter(format: PackageFormat) -> Box<dyn PackageMetadataAdapter> {
        match format {
            ...
            PackageFormat::OpenBsdPkg | PackageFormat::SolarisIps => Box::new(PkgMetadataAdapter),
