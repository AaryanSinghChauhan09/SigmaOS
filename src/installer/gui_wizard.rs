...
pub type UserAccount = UserAccountConfig;
...
impl GuiInstallerWizard {
    ...
    pub fn next_screen(&mut self) -> Result<(), InstallerError> {
        ...
        self.current_screen = match self.current_screen {
            ...
            InstallerScreen::CompleteOnboarding | InstallerScreen::Complete => return Err(InstallerError::AlreadyComplete),
        };
    ...
    pub fn get_screen_description(&self) -> &str {
        match self.current_screen {
            ...
            InstallerScreen::CompleteOnboarding | InstallerScreen::Complete => "Installation Complete",
        }
    }
