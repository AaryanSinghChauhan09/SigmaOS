...
impl SovereignDistroBootStageHandoff {
    ...
    pub fn parse_openbsd_boot_conf(&mut self, conf: &str) -> usize {
        ...
        self.openbsd_directives.len()
    }

    pub fn prepare_live_iso_overlay(&mut self, _path: &str, _size_mb: usize) -> Result<(), &'static str> {
    ...
    pub fn trigger_emergency_rescue(&mut self, msg: &str) {
        self.emergency_rescue_active = true;
        self.last_error_log = Some(msg.to_string());
    }
