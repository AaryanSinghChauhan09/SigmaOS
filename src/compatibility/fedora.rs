...
impl FedoraTahrirIdentityApiEngine {
    ...
    pub fn register_user_avatar(
        ...
        let hash = format!("{:x}", email.as_bytes().len() * 31);
        self.user_avatars.insert(
            hash.clone(),
            TahrirUserAvatar {
