...
pub use canonical::{
    AiResourceScheduler, BsdJailSandbox, CompatBinary, CompatBinaryFormat, CompatibilityLayer,
    ContinuityCoordinator, DesktopMode, EcosystemSnapshot, FlatpakApp, HandoffTask,
    SnapshotManager, UnifiedAppStore, ZorinAppearanceSwitcher,
};
