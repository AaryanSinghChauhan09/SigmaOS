# Storage Branch Wiki (Sovereign Filesystem)

This knowledge base governs the development of the SigmaOS storage subsystems within the `storage` branch.
...
- **Virtual Filesystem (VFS)**: The abstraction layer handling disparate device drivers.
