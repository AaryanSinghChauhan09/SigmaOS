...
2. **Flash**: Write to USB or deploy as a lightweight VM/Container host.

3. **Connect**: On first boot, the **SovereignNet** shard will automatically negotiate a PQC-secure handshake with the nearest lattice gateway.
