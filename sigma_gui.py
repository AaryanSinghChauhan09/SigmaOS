...
try:
    ...
    from gui_pkg.recovery import handle_kernel_fault
    TK_AVAILABLE = True
except ImportError:
    TK_AVAILABLE = False
...
class SigmaGUI(tk.Tk, UIMixin):
    ...
    def _on_kernel_fault(self, exc_type, exc_val, exc_tb):
        ...
        handle_kernel_fault(self, exc_type, exc_val, exc_tb, self._is_child_mode())
    ...
    def _build_ui(self):
        ...
        self._page_defs = {
            "dashboard":        lambda: self._set_modular_page("dashboard", DashboardPage),
            "browser":          lambda: self._set_modular_page("browser", BrowserPage),
            "explorer":         lambda: self._set_modular_page("explorer", ExplorerPage),
            "projects":         lambda: self._set_modular_page("projects", ProjectCenterPage),
            "law_pro":          lambda: self._set_modular_page("law_pro", LawPage),
            "buyhatke":         lambda: self._set_modular_page("buyhatke", BuyhatkePage),
            "search":           lambda: self._set_modular_page("search", SearchPage),
            "prompt_o_matic":   lambda: self._set_modular_page("prompt_o_matic", PromptOMaticPage),
            "routines_dash":    lambda: self._set_modular_page("routines_dash", RoutinesDashPage),
