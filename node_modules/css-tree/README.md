...
CSSTree is a tool set for CSS: [fast](https://github.com/postcss/benchmark) detailed parser (CSS â†’ AST), walker (AST traversal), generator (AST â†’ CSS) and lexer (validation and matching) based on specs and browser implementations. The main goal is to be efficient and W3C spec compliant, with focus on CSS analyzing and source-to-source transforming tasks.
...
- [Svelte](https://github.com/sveltejs/svelte) â€“ Cybernetically enhanced web apps

- [SVGO](https://github.com/svg/svgo) â€“ Node.js tool for optimizing SVG files

- [CSSO](https://github.com/css/csso) â€“ CSS minifier with structural optimizations

- [NativeScript](https://github.com/NativeScript/NativeScript) â€“ NativeScript empowers you to access native APIs from JavaScript directly

- [react-native-svg](https://github.com/react-native-svg/react-native-svg) â€“ SVG library for React Native, React Native Web, and plain React web projects

- [penthouse](https://github.com/pocketjoso/penthouse) â€“ Critical Path CSS Generator

- [Bit](https://github.com/teambit/bit) â€“ Bit is the platform for collaborating on components
...
- [Parsing CSS â†’ AST](docs/parsing.md)
  - [parse(source[, options])](docs/parsing.md#parsesource-options)

- [Serialization AST â†’ CSS](docs/generate.md)
...
- [AST Explorer](https://astexplorer.net/#/gist/244e2fb4da940df52bf0f4b94277db44/e79aff44611020b22cfd9708f3a99ce09b7d67a8) â€“ explore CSSTree AST format with zero setup
...
- [csstree-validator](https://github.com/csstree/validator) â€“Â NPM package to validate CSS

- [stylelint-csstree-validator](https://github.com/csstree/stylelint-validator) â€“ plugin for stylelint to validate CSS
...
- `dist/csstree.js` â€“ minified IIFE with `csstree` as global
...
- `dist/csstree.esm.js` â€“ minified ES module
