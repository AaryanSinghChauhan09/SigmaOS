...
| Compression support         | âœ…     | âŒ                      | âœ…                    | âœ…                             |
| ZIP support                 | âŒ     | âŒ                      | âœ…                    | âœ…                             |
| Streaming support           | âœ…     | âŒ                      | âŒ                    | âœ…                             |
| GZIP support                | âœ…     | âŒ                      | âŒ                    | âœ…                             |
| Supports files up to 4GB    | âœ…     | âŒ                      | âŒ                    | âœ…                             |
| Doesn't hang on error       | âœ…     | âŒ                      | âŒ                    | âœ…                             |
| Dictionary support          | âœ…     | âŒ                      | âŒ                    | âœ…                             |
| Multi-thread/Asynchronous   | âŒ     | âŒ                      | âŒ                    | âœ…                             |
| Streaming ZIP support       | âŒ     | âŒ                      | âŒ                    | âœ…                             |
| Uses ES Modules             | âŒ     | âŒ                      | âŒ                    | âœ…                             |
