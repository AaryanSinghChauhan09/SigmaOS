...
Note: The `nameRaw` property represents the name _as parsed from the original source_, including escape sequences. The `name` property represents the canonical decoded form of the name.
...
Note: The `referenceRaw` property represents the reference _as parsed from the original source_, including escape sequences. The `reference` property represents the canonical decoded form of the reference.
