...
- [SymbolTree](#exp_module_symbol-tree--SymbolTree) â

- [new SymbolTree([description])](#new_module_symbol-tree--SymbolTree_new)

- [.initialize(object)](#module_symbol-tree--SymbolTree+initialize) â‡’ <code>Object</code>

- [.hasChildren(object)](#module_symbol-tree--SymbolTree+hasChildren) â‡’ <code>Boolean</code>

- [.firstChild(object)](#module_symbol-tree--SymbolTree+firstChild) â‡’ <code>Object</code>

- [.lastChild(object)](#module_symbol-tree--SymbolTree+lastChild) â‡’ <code>Object</code>

- [.previousSibling(object)](#module_symbol-tree--SymbolTree+previousSibling) â‡’ <code>Object</code>

- [.nextSibling(object)](#module_symbol-tree--SymbolTree+nextSibling) â‡’ <code>Object</code>

- [.parent(object)](#module_symbol-tree--SymbolTree+parent) â‡’ <code>Object</code>

- [.lastInclusiveDescendant(object)](#module_symbol-tree--SymbolTree+lastInclusiveDescendant) â‡’ <code>Object</code>

- [.preceding(object, [options])](#module_symbol-tree--SymbolTree+preceding) â‡’ <code>Object</code>

- [.following(object, [options])](#module_symbol-tree--SymbolTree+following) â‡’ <code>Object</code>

- [.childrenToArray(parent, [options])](#module_symbol-tree--SymbolTree+childrenToArray) â‡’ <code>Array.&lt;Object&gt;</code>

- [.ancestorsToArray(object, [options])](#module_symbol-tree--SymbolTree+ancestorsToArray) â‡’ <code>Array.&lt;Object&gt;</code>

- [.treeToArray(root, [options])](#module_symbol-tree--SymbolTree+treeToArray) â‡’ <code>Array.&lt;Object&gt;</code>

- [.childrenIterator(parent, [options])](#module_symbol-tree--SymbolTree+childrenIterator) â‡’ <code>Object</code>

- [.previousSiblingsIterator(object)](#module_symbol-tree--SymbolTree+previousSiblingsIterator) â‡’ <code>Object</code>

- [.nextSiblingsIterator(object)](#module_symbol-tree--SymbolTree+nextSiblingsIterator) â‡’ <code>Object</code>

- [.ancestorsIterator(object)](#module_symbol-tree--SymbolTree+ancestorsIterator) â‡’ <code>Object</code>

- [.treeIterator(root, options)](#module_symbol-tree--SymbolTree+treeIterator) â‡’ <code>Object</code>

- [.index(child)](#module_symbol-tree--SymbolTree+index) â‡’ <code>Number</code>

- [.childrenCount(parent)](#module_symbol-tree--SymbolTree+childrenCount) â‡’ <code>Number</code>

- [.compareTreePosition(left, right)](#module_symbol-tree--SymbolTree+compareTreePosition) â‡’ <code>Number</code>

- [.remove(removeObject)](#module_symbol-tree--SymbolTree+remove) â‡’ <code>Object</code>

- [.insertBefore(referenceObject, newObject)](#module_symbol-tree--SymbolTree+insertBefore) â‡’ <code>Object</code>

- [.insertAfter(referenceObject, newObject)](#module_symbol-tree--SymbolTree+insertAfter) â‡’ <code>Object</code>

- [.prependChild(referenceObject, newObject)](#module_symbol-tree--SymbolTree+prependChild) â‡’ <code>Object</code>

- [.appendChild(referenceObject, newObject)](#module_symbol-tree--SymbolTree+appendChild) â‡’ <code>Object</code>
...
#### symbolTree.initialize(object) â‡’ <code>Object</code>
...
#### symbolTree.hasChildren(object) â‡’ <code>Boolean</code>
...
#### symbolTree.firstChild(object) â‡’ <code>Object</code>
...
#### symbolTree.lastChild(object) â‡’ <code>Object</code>
...
#### symbolTree.previousSibling(object) â‡’ <code>Object</code>
...
#### symbolTree.nextSibling(object) â‡’ <code>Object</code>
...
#### symbolTree.parent(object) â‡’ <code>Object</code>
...
#### symbolTree.lastInclusiveDescendant(object) â‡’ <code>Object</code>
...
#### symbolTree.preceding(object, [options]) â‡’ <code>Object</code>
...
#### symbolTree.following(object, [options]) â‡’ <code>Object</code>
...
#### symbolTree.childrenToArray(parent, [options]) â‡’ <code>Array.&lt;Object&gt;</code>
...
#### symbolTree.ancestorsToArray(object, [options]) â‡’ <code>Array.&lt;Object&gt;</code>
...
#### symbolTree.treeToArray(root, [options]) â‡’ <code>Array.&lt;Object&gt;</code>
...
#### symbolTree.childrenIterator(parent, [options]) â‡’ <code>Object</code>
...
#### symbolTree.previousSiblingsIterator(object) â‡’ <code>Object</code>
...
#### symbolTree.nextSiblingsIterator(object) â‡’ <code>Object</code>
...
#### symbolTree.ancestorsIterator(object) â‡’ <code>Object</code>
...
#### symbolTree.treeIterator(root, options) â‡’ <code>Object</code>
...
#### symbolTree.index(child) â‡’ <code>Number</code>
...
#### symbolTree.childrenCount(parent) â‡’ <code>Number</code>
...
#### symbolTree.compareTreePosition(left, right) â‡’ <code>Number</code>
...
#### symbolTree.remove(removeObject) â‡’ <code>Object</code>
...
#### symbolTree.insertBefore(referenceObject, newObject) â‡’ <code>Object</code>
...
#### symbolTree.insertAfter(referenceObject, newObject) â‡’ <code>Object</code>
...
#### symbolTree.prependChild(referenceObject, newObject) â‡’ <code>Object</code>
...
#### symbolTree.appendChild(referenceObject, newObject) â‡’ <code>Object</code>
