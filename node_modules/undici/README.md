...
â”‚  Tests                 â”‚ Samples â”‚ Result             â”‚ Tolerance  â”‚ Difference with slowest â”‚
â”œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¼â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¼â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¼â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¼â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¤
â”‚  'axios'               â”‚ 15      â”‚ '5708.26 req/sec'  â”‚ 'Â± 2.91 %' â”‚ '-'                     â”‚
â”‚  'http - no keepalive' â”‚ 10      â”‚ '5809.80 req/sec'  â”‚ 'Â± 2.30 %' â”‚ '+ 1.78 %'              â”‚

â”‚  'request'             â”‚ 30      â”‚ '5828.80 req/sec'  â”‚ 'Â± 2.91 %' â”‚ '+ 2.11 %'              â”‚

â”‚  'undici - fetch'      â”‚ 40      â”‚ '5903.78 req/sec'  â”‚ 'Â± 2.87 %' â”‚ '+ 3.43 %'              â”‚

â”‚  'node-fetch'          â”‚ 10      â”‚ '5945.40 req/sec'  â”‚ 'Â± 2.13 %' â”‚ '+ 4.15 %'              â”‚

â”‚  'got'                 â”‚ 35      â”‚ '6511.45 req/sec'  â”‚ 'Â± 2.84 %' â”‚ '+ 14.07 %'             â”‚

â”‚  'http - keepalive'    â”‚ 65      â”‚ '9193.24 req/sec'  â”‚ 'Â± 2.92 %' â”‚ '+ 61.05 %'             â”‚

â”‚  'superagent'          â”‚ 35      â”‚ '9339.43 req/sec'  â”‚ 'Â± 2.95 %' â”‚ '+ 63.61 %'             â”‚

â”‚  'undici - pipeline'   â”‚ 50      â”‚ '13364.62 req/sec' â”‚ 'Â± 2.93 %' â”‚ '+ 134.13 %'            â”‚

â”‚  'undici - stream'     â”‚ 95      â”‚ '18245.36 req/sec' â”‚ 'Â± 2.99 %' â”‚ '+ 219.63 %'            â”‚

â”‚  'undici - request'    â”‚ 50      â”‚ '18340.17 req/sec' â”‚ 'Â± 2.84 %' â”‚ '+ 221.29 %'            â”‚

â”‚  'undici - dispatch'   â”‚ 40      â”‚ '22234.42 req/sec' â”‚ 'Â± 2.94 %' â”‚ '+ 289.51 %'            â”‚
...
|----------------|-------------------|----------------------------|-------------|
| 5.x           | 18.x              | â‰¥14.0 (tested: 14, 16, 18) | 2024-04-30  |
| 6.x           | 20.x, 22.x       | â‰¥18.17 (tested: 18, 20, 21, 22) | 2026-04-30  |
| 7.x           | 24.x              | â‰¥20.18.1 (tested: 20, 22, 24) | 2027-04-30  |
