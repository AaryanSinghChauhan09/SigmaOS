...
# .makeRe star (*)
  ...
  picomatch x 3,251,247 ops/sec Â±0.25% (95 runs sampled)
  minimatch x 497,224 ops/sec Â±0.11% (100 runs sampled)

# .makeRe star; dot=true (*)

  picomatch x 2,624,035 ops/sec Â±0.16% (98 runs sampled)
  minimatch x 446,244 ops/sec Â±0.63% (99 runs sampled)

# .makeRe globstar (**)

  picomatch x 2,524,465 ops/sec Â±0.13% (99 runs sampled)
  minimatch x 1,396,257 ops/sec Â±0.58% (96 runs sampled)

# .makeRe globstars (**/**/**)

  picomatch x 2,545,674 ops/sec Â±0.10% (99 runs sampled)
  minimatch x 1,196,835 ops/sec Â±0.63% (98 runs sampled)

# .makeRe with leading star (*.txt)

  picomatch x 2,537,708 ops/sec Â±0.11% (100 runs sampled)
  minimatch x 345,284 ops/sec Â±0.64% (96 runs sampled)

# .makeRe - basic braces ({a,b,c}*.txt)

  picomatch x 505,430 ops/sec Â±1.04% (94 runs sampled)
  minimatch x 107,991 ops/sec Â±0.54% (99 runs sampled)

# .makeRe - short ranges ({a..z}*.txt)

  picomatch x 371,179 ops/sec Â±2.91% (77 runs sampled)
  minimatch x 14,104 ops/sec Â±0.61% (99 runs sampled)

# .makeRe - medium ranges ({1..100000}*.txt)

  picomatch x 384,958 ops/sec Â±1.70% (82 runs sampled)
  minimatch x 2.55 ops/sec Â±3.22% (11 runs sampled)

# .makeRe - long ranges ({1..10000000}*.txt)

  picomatch x 382,552 ops/sec Â±1.52% (71 runs sampled)
  minimatch x 0.83 ops/sec Â±5.67% (7 runs sampled))
```
