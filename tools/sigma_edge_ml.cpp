/*
 * =========================================================================
 * Î£ SIGMAOS: HARDENED COOPERATIVE AI/ML ENGINE (sigma_edge_ml) v1.3
 * =========================================================================
...
public:
    ...
    void run_multi_agent_cooperation() {
        if (m_active_agents < 2) {
            sigma_log_info("[AGENT] Error: Multi-agent OWL orchestration requires at least 2 active agents.");
            return;
        }
