...
private:
    ...
    void scan_active_shards() {
        ...
        sigma_log_warn("[FORENSICS] Signature [exec_hijack] matched in Ring-3 buffer 0x7FFF0042.");
        sigma_log_warn("[FORENSICS]   - Severity: CRITICAL");
        sigma_log_warn("[FORENSICS]   - Description: Process memory hijacking vector");
        m_threats_found++;
    }
