...
| Pod lifecycle logging (`sigma_pod.log`) | [ ] | Orchestration | `userland/tools/sigma_pod_cli.cpp` |
...
| Bootloader UI “Fix it” menu | [ ] | Kernel/Boot | `suites/S41_SiliconBoot/` |
...
| Auto-tiling WM (BSP/columns/grid) | [~] | GUI/UX | `zenith_desktop/wm/sigma_tiling_wm.cpp` |
