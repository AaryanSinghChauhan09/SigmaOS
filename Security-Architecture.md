...
*   CAP\_NET\_ADMIN — network configuration
*   CAP\_SYS\_PTRACE — process tracing
*   CAP\_DAC\_OVERRIDE — filesystem permission bypass
*   CAP\_SETUID/SETGID — privilege changes
...
*   ✅ XSS prevention in web\_ui components
...
*See also: [SECURITY\_HARDENING\_COMPLETE.md](https://github.com/AaryanSinghChauhan09/SigmaOS/blob/main/SECURITY_HARDENING_COMPLETE.md)*
