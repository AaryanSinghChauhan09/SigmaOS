...
// ─── Module: Sigma::IZenithExperiment ─────────────────────

/// IZenithExperiment — OOP singleton pattern.
pub struct IZenithExperiment {
    pub initialized: SigmaBool,
}

impl IZenithExperiment {
...
static mut INSTANCE: IZenithExperiment = IZenithExperiment::new();
