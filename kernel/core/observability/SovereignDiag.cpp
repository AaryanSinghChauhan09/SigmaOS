...
void SovereignDiagEngine::init() {
    ...
    this->getInstance().getInstance().getInstance().getInstance().getInstance().m_initialized = 1U;
    getInstance().getInstance().getInstance().getInstance().getInstance().m_fault_count = 0U;
}
