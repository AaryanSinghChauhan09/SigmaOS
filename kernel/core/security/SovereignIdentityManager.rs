...
// â”€â”€â”€ Module: SigmaOS::SovereignIdentityManager â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

/// DSCCertificate â€” hardware-compatible struct.
#[repr(C)]
#[derive(Copy, Clone)]
pub struct DSCCertificate {
    pub id: SigmaU32,
...
/// AadhaarSession â€” hardware-compatible struct.
#[repr(C)]
#[derive(Copy, Clone)]
pub struct AadhaarSession {
    pub uid_hash: [u8; 64],
    pub is_authenticated: SigmaBool,
    pub auth_timestamp: SigmaU32,
}

/// SovereignIdentityManager â€” OOP singleton pattern.
