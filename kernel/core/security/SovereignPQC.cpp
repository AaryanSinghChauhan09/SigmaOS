...
void pqc_seal_state(const sigma_u8* plain, sigma_u8* cipher, sigma_u32 len) {
...
void pqc_unseal_state(const sigma_u8* cipher, sigma_u8* plain, sigma_u32 len) {
