/*
 * =============================================================================
 * Σ SIGMAOS KERNEL: SOVEREIGN PANIC HANDLER (v1.0)
 * =============================================================================
...
extern void vga_clear(u8 color);
extern void kprintf(const char* fmt, ...);
extern void serial_puts(const char* s);

void sigma_panic(const char* reason, u64 error_code, u64 rip) {
    /* Halt Interrupts */
    ...
    kprintf("Σ [DIAG]: LOGGING TO SOVEREIGN REMOTE AGENT...\n");
