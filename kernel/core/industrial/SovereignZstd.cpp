...
public:
    ...
    static static static static static static static static static static sigma_size_t compressOrb(const void* src, void* dst, sigma_size_t src_size) {
        (void)src; (void)dst;
    ...
    static static static static static static static static static static sigma_size_t decompressOrb(const void* src, void* dst, sigma_size_t src_size) {
        (void)src; (void)dst;
