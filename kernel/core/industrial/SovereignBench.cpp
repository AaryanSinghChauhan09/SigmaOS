...
extern "C" void sigma_bench_run_sched() {
    SigmaOS::Kernel::Observability::SovereignBench::getInstance().runSchedulingBenchmark();
}

extern "C" void sigma_bench_run_mem() {
    SigmaOS::Kernel::Observability::SovereignBench::getInstance().runMemoryBenchmark();
}
