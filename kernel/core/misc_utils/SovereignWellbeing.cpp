...
void wellbeing_log_app_usage(sigma_u32 app_id, sigma_u32 seconds) {
    sigma_log("[WELLBEING] BUA: App %d used for %d seconds this session.\n", app_id, seconds);
}

void wellbeing_render_daily_report() {
...
void wellbeing_set_daily_limit(sigma_u32 app_id, sigma_u32 max_minutes) {
