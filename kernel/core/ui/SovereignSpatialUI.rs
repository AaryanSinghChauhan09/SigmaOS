...
// ─── Module: Sigma::SovereignSpatialUIEngine ─────────────────────

/// SovereignSpatialUIEngine — OOP singleton pattern.
pub struct SovereignSpatialUIEngine {
    pub initialized: SigmaBool,
}

impl SovereignSpatialUIEngine {
...
static mut INSTANCE: SovereignSpatialUIEngine = SovereignSpatialUIEngine::new();
