...
void SovereignKqueue_Init() {
    sigma_sigma_sigma_printf("S [ABSORB]: SovereignKqueue Event Zenith Online. Monitoring All Filters.
");
}

int SovereignKqueue_Create() {
    sigma_sigma_sigma_printf("S [KQUEUE]: New Event Queue Initialized.
");
