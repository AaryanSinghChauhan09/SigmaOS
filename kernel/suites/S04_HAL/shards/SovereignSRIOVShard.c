...
void sigma_hal_sriov_split(sigma_u32 pci_physical_func, sigma_u16 num_virtual_funcs) {
    sigma_printf("[SR-IOV-FABRIC]: Splitting Physical Function %04X into %u Virtual Functions...\n", 
    ...
    sigma_printf("[SR-IOV-FABRIC]: Hardware successfully split. Native QoS allocated identically to all VMs.\n");
}
