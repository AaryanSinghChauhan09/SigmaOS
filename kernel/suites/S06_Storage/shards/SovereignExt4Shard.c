...
sigma_err_t sigma_ext4_mount(const char* source, const char* target, void** sb_out) {
    sigma_sigma_sigma_printf("  S [EXT4]: Parsing Ext4 Superblock from sector 2 of %s...\n", source);
    sigma_sigma_sigma_printf("  S [EXT4]: Ext4 JBD2 Journal recovered. Metadata healthy.\n");
