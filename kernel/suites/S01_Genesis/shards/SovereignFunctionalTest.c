...
void sigma_test_memory() {
    sigma_printf("S [TEST]: Validating Memory Suite...\n");
...
void sigma_test_crypto() {
    sigma_printf("S [TEST]: Validating Crypto Suite...\n");
    sigma_u8 digest[32];
...
void sigma_test_cli() {
    sigma_printf("S [TEST]: Validating CLI Framework...\n");
...
void sigma_test_security() {
    sigma_printf("S [TEST]: Validating Security Suite...\n");
...
void SovereignFunctionalTest_Run(void) {
    sigma_printf("\nS ==========================================================\n");
    sigma_printf("S [SOVEREIGN TEST RUNNER]: STARTING INTEGRITY AUDIT\n");
    sigma_printf("S ==========================================================\n");
