/*
 * =========================================================================
 * Σ SIGMAOS: S01_GENESIS — SovereignSyscallDispatcher.c
 * =========================================================================
...
static uint64_t sys_yield(uint64_t a, uint64_t b, uint64_t c, uint64_t d, uint64_t e, uint64_t f) {
    ...
    sigma_printf("Σ [SYSCALL]: Thread yielded.\n");
    return 0;
}
...
void syscall_dispatcher_init(void) {
    ...
    sigma_printf("Σ [S01]: Sovereign Syscall Table Materialized (512 Vectors).\n");
}
