...
sigma_err_t sigma_nix_immutable_init(void) {
    ...
    sigma_printf("  ↳ APT/DNF/Pacman bypassed. Dependencies are permanently compiled directly into S-Mem structures.\n");
    sigma_printf("  ↳ S12_Ecosystem can inherently execute ANY deb/rpm/nix file via zero-cost structural transformation.\n");
