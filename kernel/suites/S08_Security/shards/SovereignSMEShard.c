...
void sigma_sec_sme_enable(void) {
    sigma_printf("[SME-VAULT]: Engaging AES-128 inline memory controller encryption...\n");
    // Memory written to RAM is physically encrypted, memory read is decrypted on the fly by the CPU
    sigma_printf("[SME-VAULT]: RAM physically encrypted. Cold-boot extraction attacks absolutely neutralized.\n");
}
