 ...
 */
sigma_u64 sigma_crypto_hash(const void* data, sigma_size_t len) {
 ...
 */
void sigma_crypto_transform(void* data, sigma_size_t len, sigma_u64 key) {
 ...
 */
int sigma_crypto_verify(const void* a, const void* b, sigma_size_t len) {
