...
void sigma_opt_css_interact(SigmaCParticle_t* p1, SigmaCParticle_t* p2) {
    sigma_printf("[CSS-CORE]: Computing Coulomb-based interaction for node distribution...\n");
    // F = q1*q2 / r^2 (within sphere) or q1*q2*r / R^3 (outside)
    sigma_printf("[CSS-CORE]: Force integrated. Shard repulsion/attraction SEATED.\n");
}
