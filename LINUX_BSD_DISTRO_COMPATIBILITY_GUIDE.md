...
SigmaOS directly translates foreign System V x86\_64 ABI syscalls into native microkernel capabilities without requiring virtual machine emulation:

*   **Linux x86\_64 ABI:** Full dispatch support for standard Linux syscalls including `read(0)`, `write(1)`, `open(2)`, `close(3)`, `mmap(9)`, `brk(12)`, and `exit(60)`.
