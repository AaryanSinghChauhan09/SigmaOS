...
*   \[ ] arch (x86\_64, ARM64, RISC-V)

*   \[ ] sigma-sh (shell REPL)

*   \[ ] sigma-pkg (package manager, registry)

*   \[ ] zenith\_desktop (compositor, WM, GUI)
...
*   \[ ] x86\_64-unknown-none (kernel no\_std)

*   \[ ] aarch64-unknown-none

*   \[ ] riscv64gc-unknown-none-elf

*   \[ ] x86\_64-unknown-linux-gnu (host tools / sigma-sh)
