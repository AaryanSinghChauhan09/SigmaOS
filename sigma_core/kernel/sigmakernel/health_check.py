"""
Auto-split from sigma_core\kernel.py — SigmaKernel.health_check
"""
...
class SigmaKernel:
    def health_check(self) -> dict:
        return {'status': 'ONLINE', 'kernel': 'ONLINE', 'version': getattr(self, 'version', 'UNKNOWN'), 'shards': self.registry.health_check() if self.registry else {}}
