...
class SigmaKernel:
    ...
    def _initialize_advanced_shards(self):
        ...
        advanced = {
            ...
            "sovereign_agent": self.agent, "chat_engine": self.chat_engine,
            "multi_ai": self.multi_ai, "flowchart": self.flowchart,
            "titan_capture": self.titan_capture
        }
