# Generated method: SecurePacket.construct
...
class SecurePacket:
    ...
    def construct(p_type: str, sender_sid: str, payload: bytes, shared_secret: bytes) -> Dict:
        ...
        return {'type': p_type, 'from': sender_sid, 'payload': encrypted.hex(), 'nonce': nonce, 'sig': SigmaCrypto.sign(encrypted.hex(), sender_sid)}