# Generated method: SovereignChatEngine.health_check
import socket
import threading
import time
import json
...
class SovereignChatEngine:
    def health_check(self) -> dict:
        return {'status': 'ONLINE' if self._running else 'OFFLINE', 'sid': self.identity.sid, 'alias': self.identity.alias, 'peers': self.peer_dir.count_peers(), 'stats': self.stats}