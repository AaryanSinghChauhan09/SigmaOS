# Generated method: SigmaOmniAutomator.synthesize_from_genome
...
class SigmaOmniAutomator:
    def synthesize_from_genome(self, genome_sig: str) -> str:
        return synthesize_from_genome(genome_sig, self.workflow_genome_db, self.transparent_ledger, self.stats, self.kernel)