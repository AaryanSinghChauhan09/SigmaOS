...
class SigmaThemeEngine(SigmaModuleBase):
    def __init__(self, kernel=None):
        ...
        self.AURAS = {
            "DeepSpace":  {"bg": "#0D0D0D", "accent": "#00FFC2", "term": "Glassmorphism", "icon": "🌌"},
            "SolarApex":  {"bg": "#FFFFFF", "accent": "#FF4D00", "term": "SleekLight", "icon": "☀️"},
            "CyberPunk":  {"bg": "#1A0033", "accent": "#FF00FF", "term": "NeonRetro", "icon": "⚡"},
            "MatrixOS":   {"bg": "#000000", "accent": "#00FF00", "term": "Monospace-Classic", "icon": "📟"},
            "Zodiac":     {"bg": "#121212", "accent": "#6C63FF", "term": "VelvetDark", "icon": "✨"}
        }
