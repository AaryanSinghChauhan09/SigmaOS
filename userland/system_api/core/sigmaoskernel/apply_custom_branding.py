"""
Auto-split from userland\system_api\core.py — SigmaOSKernel.apply_custom_branding
"""
...
class SigmaOSKernel:
    def apply_custom_branding(self, logo_path, theme_color='#1A1A2E'):
        ...
        self.config = {'OS_Logo': logo_path, 'Accent_Color': theme_color, 'Branding': 'Active-Custom'}
