# Generated method: SovereignCommsPage._build_ui
...
class SovereignCommsPage:
    def _build_ui(self):
        ...
        msgs = [('Zoho Lead', 'New inquiry regarding Apex v4 license', 'Just now'), ('WA #9876', 'Bulk send request confirmed - 10k messages', '5m ago'), ('Salesforce', "Opportunity: 'Global Tech' moved to CLOSED", '1h ago'), ('Google Meet', 'EmotionSense Pro: Participation Low (32%)', '2h ago')]
        ...
        tk.Checkbutton(wait_fr, text='🛑 Wait Guard (WaitAIMinute USP)', variable=self._wait_guard, bg=PAL['bg3'], fg=PAL['gold'], selectcolor=PAL['bg2'], command=lambda: self.gui._log_voice('Comms: Wait Guard active. 60s delay enforced on replies.')).pack(anchor='w')
