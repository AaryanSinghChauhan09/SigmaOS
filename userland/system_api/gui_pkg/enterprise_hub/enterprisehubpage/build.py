# Generated method: EnterpriseHubPage.build
...
class EnterpriseHubPage:
    def build(self):
        ...
        tools = [('📝 SOP Scribe (Scribe USP)', 'sop_scribe', 'sigma.ent.sop_scribe'), ('🎙️ Meeting AI (Fireflies)', 'meeting_ai', 'sigma.ent.meeting_ai'), ('🔍 Lead Intel (Hunter.io)', 'lead_intel', 'sigma.ent.lead_intel'), ('🖋️ Grammarian (Grammarly)', 'grammarly', 'sigma.ent.grammarly'), ('📂 Session Buddy', 'session_buddy', 'sigma.sys.session_buddy'), ('📊 Excel AI Filler', 'excel_ai', 'sigma.prod.excel_ai'), ('📄 PDF Forge', 'pdf_forge', 'sigma.prod.pdf_forge'), ('🎬 Titan Capture (Loom)', 'titan_capture', 'sigma.sys.titan_capture'), ('📋 Scrum Board', 'scrum', 'sigma.prod.scrum'), ('⚡ Sovereign De-bloater', 'debloater', 'sigma.sys.debloater')]
