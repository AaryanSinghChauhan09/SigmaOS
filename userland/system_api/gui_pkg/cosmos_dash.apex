...
class CosmosDashPage(SigmaPage):
    ...
    def build(self):
        ...
        self.fabric_label = tk.Label(card, text="Fabric: IDLE | Compute: 0 TFLOPS",
        ...
        ttk.Button(card, text="Join Hybrid Fabric",
                   command=lambda: [getattr(self.controller.kernel, 'fabric', None) and
                                    self.controller.kernel.fabric.join_compute_fabric(),
