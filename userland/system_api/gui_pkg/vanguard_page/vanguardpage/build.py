# Generated method: VanguardPage.build
...
class VanguardPage:
    def build(self):
        ...
        ttk.Button(r_fr, text='Query Global Threat DB (MeshIntel)', command=lambda: self.gui._log(self.v_log, '[VANGUARD] Requesting threat-hash verification from Mesh nodes...', 'INFO')).pack(pady=10)