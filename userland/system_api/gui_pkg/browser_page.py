...
class BrowserPage(SigmaPage):
    ...
    def _build_ui(self):
        ...
        def _go(e=None):
            ...
            if is_child:
                # Whitelist approach for 1-5 year olds
        ...
        # Text Surgeon / Magic Brush
        surgeon_text = "🖌️ Magic Brush" if is_child else "✂️ Surgeon"
        tk.Button(nav, text=surgeon_text, font=FONT_SMALL, bg=PAL["bg2"], fg=PAL["gold"], relief="flat",
