# Generated method: AetherOrchPage.build
...
class AetherOrchPage:
    def build(self):
        ...
        for agent in [('Email Discovery Agent', 'sigma.ai.email_disco'), ('Excel AI Filler', 'sigma.prod.excel_ai'), ('Aether Mesh Node', 'sigma.mesh')]:
        ...
        ttk.Button(crush_c, text='Launch Benchmark War-Room', command=lambda: self.gui._show_page('war_room')).pack(side='left', padx=5, pady=5)
