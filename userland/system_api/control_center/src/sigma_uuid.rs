...
impl SigmaUuid {
    ...
    pub fn new_v4() -> Self {
        ...
        uuid.data[8] = (uuid.data[8] & 0x3F) | 0x80; // Variant 1
...
mod tests {
    ...
    fn test_uuid_v4() {
        ...
        assert!(!uuid.is_nil());
        assert_eq!(uuid.data[6] & 0xF0, 0x40); // Version 4
        assert_eq!(uuid.data[8] & 0xC0, 0x80); // Variant 1
    }
    ...
    fn test_uuid_string() {
        ...
        assert!(len == 36); // 32 hex chars + 4 hyphens
    }
}
